...
api_instance = isi_sdk_8_0_1.DedupeApi(isi_sdk_8_0_1.ApiClient(configuration))
...
# create an instance of the API class
api_instance = isi_sdk_8_0_1.DedupeApi(isi_sdk_8_0_1.ApiClient(configuration))
dedupe_settings = isi_sdk_8_0_1.DedupeSettingsExtended() # DedupeSettingsExtended | 
