...
api_instance = isi_sdk_8_0_1.FilesystemApi(isi_sdk_8_0_1.ApiClient(configuration))
...
# create an instance of the API class
api_instance = isi_sdk_8_0_1.FilesystemApi(isi_sdk_8_0_1.ApiClient(configuration))
settings_access_time = isi_sdk_8_0_1.SettingsAccessTimeExtended() # SettingsAccessTimeExtended | 
...
# create an instance of the API class
api_instance = isi_sdk_8_0_1.FilesystemApi(isi_sdk_8_0_1.ApiClient(configuration))
settings_character_encodings = isi_sdk_8_0_1.SettingsCharacterEncodingsExtended() # SettingsCharacterEncodingsExtended | 
