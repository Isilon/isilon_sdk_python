...
class HdfsRackCreateParams(object):
    ...
    def __init__(self):
        """
        HdfsRackCreateParams - a model defined in Swagger
    ...
    def client_ip_ranges(self):
        """
        Gets the client_ip_ranges of this HdfsRackCreateParams.
        Array of IP ranges. Clients from one of these IP ranges are served by corresponding nodes from ip_pools array.

        :return: The client_ip_ranges of this HdfsRackCreateParams.
        :rtype: list[str]
        """
    ...
    def client_ip_ranges(self, client_ip_ranges):
        ...
        :param client_ip_ranges: The client_ip_ranges of this HdfsRackCreateParams.
        :type: list[str]
        """
    ...
    def ip_pools(self):
        """
        Gets the ip_pools of this HdfsRackCreateParams.
        Array of IP pool names to use for serving clients from client_ip_ranges.

        :return: The ip_pools of this HdfsRackCreateParams.
        :rtype: list[str]
        """
    ...
    def ip_pools(self, ip_pools):
        ...
        :param ip_pools: The ip_pools of this HdfsRackCreateParams.
        :type: list[str]
        """
    ...
    def name(self):
        """
        Gets the name of this HdfsRackCreateParams.
        Name of the rack

        :return: The name of this HdfsRackCreateParams.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this HdfsRackCreateParams.
        :type: str
        """
