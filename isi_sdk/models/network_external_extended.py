...
class NetworkExternalExtended(object):
    ...
    def __init__(self):
        """
        NetworkExternalExtended - a model defined in Swagger
    ...
    def sbr(self):
        """
        Gets the sbr of this NetworkExternalExtended.
        Enable or disable Source Based Routing (Defaults to false)

        :return: The sbr of this NetworkExternalExtended.
        :rtype: bool
        """
        return self._sbr
    ...
    def tcp_ports(self):
        """
        Gets the tcp_ports of this NetworkExternalExtended.
        List of client TCP ports.

        :return: The tcp_ports of this NetworkExternalExtended.
        :rtype: list[int]
        """
