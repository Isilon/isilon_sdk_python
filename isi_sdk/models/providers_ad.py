...
class ProvidersAd(object):
    ...
    def __init__(self):
        """
        ProvidersAd - a model defined in Swagger
    ...
    def allocate_gids(self):
        """
        Gets the allocate_gids of this ProvidersAd.
        ...
        :return: The allocate_gids of this ProvidersAd.
        :rtype: bool
        """
    ...
    def allocate_gids(self, allocate_gids):
        """
        Sets the allocate_gids of this ProvidersAd.
        Allocates an ID for an unmapped Active Directory (ADS) group. ADS groups without GIDs can be proactively assigned a GID by the ID mapper. If the ID mapper option is disabled, GIDs are not proactively assigned, and when a primary group for a user does not include a GID, the system may allocate one.

        :param allocate_gids: The allocate_gids of this ProvidersAd.
        :type: bool
        """
    ...
    def allocate_uids(self):
        """
        Gets the allocate_uids of this ProvidersAd.
        ...
        :return: The allocate_uids of this ProvidersAd.
        :rtype: bool
        """
    ...
    def allocate_uids(self, allocate_uids):
        """
        Sets the allocate_uids of this ProvidersAd.
        Allocates a user ID for an unmapped Active Directory (ADS) user. ADS users without UIDs can be proactively assigned a UID by the ID mapper. IF the ID mapper option is disabled, UIDs are not proactively assigned, and when an identify for a user does not include a UID, the system may allocate one.

        :param allocate_uids: The allocate_uids of this ProvidersAd.
        :type: bool
        """
    ...
    def assume_default_domain(self):
        """
        Gets the assume_default_domain of this ProvidersAd.
        Enables lookup of unqualified user names in the primary domain.

        :return: The assume_default_domain of this ProvidersAd.
        :rtype: bool
        """
    ...
    def assume_default_domain(self, assume_default_domain):
        """
        Sets the assume_default_domain of this ProvidersAd.
        Enables lookup of unqualified user names in the primary domain.

        :param assume_default_domain: The assume_default_domain of this ProvidersAd.
        :type: bool
        """
    ...
    def authentication(self):
        """
        Gets the authentication of this ProvidersAd.
        Enables authentication and identity management through the authentication provider.

        :return: The authentication of this ProvidersAd.
        :rtype: bool
        """
    ...
    def authentication(self, authentication):
        """
        Sets the authentication of this ProvidersAd.
        Enables authentication and identity management through the authentication provider.

        :param authentication: The authentication of this ProvidersAd.
        :type: bool
        """
    ...
    def check_online_interval(self):
        """
        Gets the check_online_interval of this ProvidersAd.
        Specifies the time in seconds between provider online checks.

        :return: The check_online_interval of this ProvidersAd.
        :rtype: int
        """
    ...
    def check_online_interval(self, check_online_interval):
        """
        Sets the check_online_interval of this ProvidersAd.
        Specifies the time in seconds between provider online checks.

        :param check_online_interval: The check_online_interval of this ProvidersAd.
        :type: int
        """
    ...
    def controller_time(self):
        """
        Gets the controller_time of this ProvidersAd.
        Specifies the current time for the domain controllers.

        :return: The controller_time of this ProvidersAd.
        :rtype: int
        """
    ...
    def controller_time(self, controller_time):
        """
        Sets the controller_time of this ProvidersAd.
        Specifies the current time for the domain controllers.

        :param controller_time: The controller_time of this ProvidersAd.
        :type: int
        """
    ...
    def create_home_directory(self):
        """
        Gets the create_home_directory of this ProvidersAd.
        Automatically creates a home directory on the first login.

        :return: The create_home_directory of this ProvidersAd.
        :rtype: bool
        """
    ...
    def create_home_directory(self, create_home_directory):
        """
        Sets the create_home_directory of this ProvidersAd.
        Automatically creates a home directory on the first login.

        :param create_home_directory: The create_home_directory of this ProvidersAd.
        :type: bool
        """
    ...
    def domain_controller(self):
        """
        Gets the domain_controller of this ProvidersAd.
        Specifies the domain controller to which the authentication service should send requests

        :return: The domain_controller of this ProvidersAd.
        :rtype: str
        """
    ...
    def domain_controller(self, domain_controller):
        """
        Sets the domain_controller of this ProvidersAd.
        Specifies the domain controller to which the authentication service should send requests

        :param domain_controller: The domain_controller of this ProvidersAd.
        :type: str
        """
    ...
    def domain_offline_alerts(self):
        """
        Gets the domain_offline_alerts of this ProvidersAd.
        Sends an alert if the domain goes offline.

        :return: The domain_offline_alerts of this ProvidersAd.
        :rtype: bool
        """
    ...
    def domain_offline_alerts(self, domain_offline_alerts):
        """
        Sets the domain_offline_alerts of this ProvidersAd.
        Sends an alert if the domain goes offline.

        :param domain_offline_alerts: The domain_offline_alerts of this ProvidersAd.
        :type: bool
        """
    ...
    def findable_groups(self):
        """
        Gets the findable_groups of this ProvidersAd.
        Sets list of groups that can be resolved.

        :return: The findable_groups of this ProvidersAd.
        :rtype: list[str]
        """
    ...
    def findable_groups(self, findable_groups):
        """
        Sets the findable_groups of this ProvidersAd.
        Sets list of groups that can be resolved.

        :param findable_groups: The findable_groups of this ProvidersAd.
        :type: list[str]
        """
    ...
    def findable_users(self):
        """
        Gets the findable_users of this ProvidersAd.
        Sets list of users that can be resolved.

        :return: The findable_users of this ProvidersAd.
        :rtype: list[str]
        """
    ...
    def findable_users(self, findable_users):
        """
        Sets the findable_users of this ProvidersAd.
        Sets list of users that can be resolved.

        :param findable_users: The findable_users of this ProvidersAd.
        :type: list[str]
        """
    ...
    def home_directory_template(self):
        """
        Gets the home_directory_template of this ProvidersAd.
        Specifies the path to the home directory template.

        :return: The home_directory_template of this ProvidersAd.
        :rtype: str
        """
    ...
    def home_directory_template(self, home_directory_template):
        """
        Sets the home_directory_template of this ProvidersAd.
        Specifies the path to the home directory template.

        :param home_directory_template: The home_directory_template of this ProvidersAd.
        :type: str
        """
    ...
    def ignore_all_trusts(self):
        """
        Gets the ignore_all_trusts of this ProvidersAd.
        If set to true, ignores all trusted domains.

        :return: The ignore_all_trusts of this ProvidersAd.
        :rtype: bool
        """
    ...
    def ignore_all_trusts(self, ignore_all_trusts):
        """
        Sets the ignore_all_trusts of this ProvidersAd.
        If set to true, ignores all trusted domains.

        :param ignore_all_trusts: The ignore_all_trusts of this ProvidersAd.
        :type: bool
        """
    ...
    def ignored_trusted_domains(self):
        """
        Gets the ignored_trusted_domains of this ProvidersAd.
        Includes trusted domains when 'ignore_all_trusts' is set to false.

        :return: The ignored_trusted_domains of this ProvidersAd.
        :rtype: list[str]
        """
    ...
    def ignored_trusted_domains(self, ignored_trusted_domains):
        """
        Sets the ignored_trusted_domains of this ProvidersAd.
        Includes trusted domains when 'ignore_all_trusts' is set to false.

        :param ignored_trusted_domains: The ignored_trusted_domains of this ProvidersAd.
        :type: list[str]
        """
    ...
    def include_trusted_domains(self):
        """
        Gets the include_trusted_domains of this ProvidersAd.
        Includes trusted domains when 'ignore_all_trusts' is set to true.

        :return: The include_trusted_domains of this ProvidersAd.
        :rtype: list[str]
        """
    ...
    def include_trusted_domains(self, include_trusted_domains):
        """
        Sets the include_trusted_domains of this ProvidersAd.
        Includes trusted domains when 'ignore_all_trusts' is set to true.

        :param include_trusted_domains: The include_trusted_domains of this ProvidersAd.
        :type: list[str]
        """
    ...
    def instance(self):
        """
        Gets the instance of this ProvidersAd.
        Specifies Active Directory provider instnace.

        :return: The instance of this ProvidersAd.
        :rtype: str
        """
    ...
    def instance(self, instance):
        """
        Sets the instance of this ProvidersAd.
        Specifies Active Directory provider instnace.

        :param instance: The instance of this ProvidersAd.
        :type: str
        """
    ...
    def ldap_sign_and_seal(self):
        """
        Gets the ldap_sign_and_seal of this ProvidersAd.
        Enables encryption and signing on LDAP requests.

        :return: The ldap_sign_and_seal of this ProvidersAd.
        :rtype: bool
        """
    ...
    def ldap_sign_and_seal(self, ldap_sign_and_seal):
        """
        Sets the ldap_sign_and_seal of this ProvidersAd.
        Enables encryption and signing on LDAP requests.

        :param ldap_sign_and_seal: The ldap_sign_and_seal of this ProvidersAd.
        :type: bool
        """
    ...
    def login_shell(self):
        """
        Gets the login_shell of this ProvidersAd.
        Specifies the login shell path.

        :return: The login_shell of this ProvidersAd.
        :rtype: str
        """
    ...
    def login_shell(self, login_shell):
        """
        Sets the login_shell of this ProvidersAd.
        Specifies the login shell path.

        :param login_shell: The login_shell of this ProvidersAd.
        :type: str
        """
    ...
    def lookup_domains(self):
        """
        Gets the lookup_domains of this ProvidersAd.
        Limits user and group lookups to the specified domains.

        :return: The lookup_domains of this ProvidersAd.
        :rtype: list[str]
        """
    ...
    def lookup_domains(self, lookup_domains):
        """
        Sets the lookup_domains of this ProvidersAd.
        Limits user and group lookups to the specified domains.

        :param lookup_domains: The lookup_domains of this ProvidersAd.
        :type: list[str]
        """
    ...
    def lookup_groups(self):
        """
        Gets the lookup_groups of this ProvidersAd.
        Looks up AD groups in other providers before allocating a group ID.

        :return: The lookup_groups of this ProvidersAd.
        :rtype: bool
        """
    ...
    def lookup_groups(self, lookup_groups):
        """
        Sets the lookup_groups of this ProvidersAd.
        Looks up AD groups in other providers before allocating a group ID.

        :param lookup_groups: The lookup_groups of this ProvidersAd.
        :type: bool
        """
    ...
    def lookup_normalize_groups(self):
        """
        Gets the lookup_normalize_groups of this ProvidersAd.
        Normalizes AD group names to lowercase before look up.

        :return: The lookup_normalize_groups of this ProvidersAd.
        :rtype: bool
        """
    ...
    def lookup_normalize_groups(self, lookup_normalize_groups):
        """
        Sets the lookup_normalize_groups of this ProvidersAd.
        Normalizes AD group names to lowercase before look up.

        :param lookup_normalize_groups: The lookup_normalize_groups of this ProvidersAd.
        :type: bool
        """
    ...
    def lookup_normalize_users(self):
        """
        Gets the lookup_normalize_users of this ProvidersAd.
        Normalize AD user names to lowercase before look up.

        :return: The lookup_normalize_users of this ProvidersAd.
        :rtype: bool
        """
    ...
    def lookup_normalize_users(self, lookup_normalize_users):
        """
        Sets the lookup_normalize_users of this ProvidersAd.
        Normalize AD user names to lowercase before look up.

        :param lookup_normalize_users: The lookup_normalize_users of this ProvidersAd.
        :type: bool
        """
    ...
    def lookup_users(self):
        """
        Gets the lookup_users of this ProvidersAd.
        Looks up AD users in other providers before allocating a user ID.

        :return: The lookup_users of this ProvidersAd.
        :rtype: bool
        """
    ...
    def lookup_users(self, lookup_users):
        """
        Sets the lookup_users of this ProvidersAd.
        Looks up AD users in other providers before allocating a user ID.

        :param lookup_users: The lookup_users of this ProvidersAd.
        :type: bool
        """
    ...
    def machine_name(self):
        """
        Gets the machine_name of this ProvidersAd.
        Specifies name to join AD as.

        :return: The machine_name of this ProvidersAd.
        :rtype: str
        """
    ...
    def machine_name(self, machine_name):
        """
        Sets the machine_name of this ProvidersAd.
        Specifies name to join AD as.

        :param machine_name: The machine_name of this ProvidersAd.
        :type: str
        """
    ...
    def machine_password_changes(self):
        """
        Gets the machine_password_changes of this ProvidersAd.
        Enables periodic changes of the machine password for security.

        :return: The machine_password_changes of this ProvidersAd.
        :rtype: bool
        """
    ...
    def machine_password_changes(self, machine_password_changes):
        """
        Sets the machine_password_changes of this ProvidersAd.
        Enables periodic changes of the machine password for security.

        :param machine_password_changes: The machine_password_changes of this ProvidersAd.
        :type: bool
        """
    ...
    def machine_password_lifespan(self):
        """
        Gets the machine_password_lifespan of this ProvidersAd.
        Sets maximum age of a password in seconds.

        :return: The machine_password_lifespan of this ProvidersAd.
        :rtype: int
        """
    ...
    def machine_password_lifespan(self, machine_password_lifespan):
        """
        Sets the machine_password_lifespan of this ProvidersAd.
        Sets maximum age of a password in seconds.

        :param machine_password_lifespan: The machine_password_lifespan of this ProvidersAd.
        :type: int
        """
    ...
    def node_dc_affinity(self):
        """
        Gets the node_dc_affinity of this ProvidersAd.
        Specifies the domain controller for which the node has affinity.

        :return: The node_dc_affinity of this ProvidersAd.
        :rtype: str
        """
    ...
    def node_dc_affinity(self, node_dc_affinity):
        """
        Sets the node_dc_affinity of this ProvidersAd.
        Specifies the domain controller for which the node has affinity.

        :param node_dc_affinity: The node_dc_affinity of this ProvidersAd.
        :type: str
        """
    ...
    def node_dc_affinity_timeout(self):
        """
        Gets the node_dc_affinity_timeout of this ProvidersAd.
        Specifies the timeout for the domain controller for which the local node has affinity.

        :return: The node_dc_affinity_timeout of this ProvidersAd.
        :rtype: int
        """
    ...
    def node_dc_affinity_timeout(self, node_dc_affinity_timeout):
        """
        Sets the node_dc_affinity_timeout of this ProvidersAd.
        Specifies the timeout for the domain controller for which the local node has affinity.

        :param node_dc_affinity_timeout: The node_dc_affinity_timeout of this ProvidersAd.
        :type: int
        """
    ...
    def nss_enumeration(self):
        """
        Gets the nss_enumeration of this ProvidersAd.
        Enables the Active Directory provider to respond to 'getpwent' and 'getgrent' requests.

        :return: The nss_enumeration of this ProvidersAd.
        :rtype: bool
        """
    ...
    def nss_enumeration(self, nss_enumeration):
        """
        Sets the nss_enumeration of this ProvidersAd.
        Enables the Active Directory provider to respond to 'getpwent' and 'getgrent' requests.

        :param nss_enumeration: The nss_enumeration of this ProvidersAd.
        :type: bool
        """
    ...
    def password(self):
        """
        Gets the password of this ProvidersAd.
        Specifies the password used during domain join.

        :return: The password of this ProvidersAd.
        :rtype: str
        """
    ...
    def password(self, password):
        """
        Sets the password of this ProvidersAd.
        Specifies the password used during domain join.

        :param password: The password of this ProvidersAd.
        :type: str
        """
    ...
    def reset_schannel(self):
        """
        Gets the reset_schannel of this ProvidersAd.
        Resets the secure channel to the primary domain.

        :return: The reset_schannel of this ProvidersAd.
        :rtype: bool
        """
    ...
    def reset_schannel(self, reset_schannel):
        """
        Sets the reset_schannel of this ProvidersAd.
        Resets the secure channel to the primary domain.

        :param reset_schannel: The reset_schannel of this ProvidersAd.
        :type: bool
        """
    ...
    def restrict_findable(self):
        """
        Gets the restrict_findable of this ProvidersAd.
        Check the provider for filtered lists of findable and unfindable users and groups.

        :return: The restrict_findable of this ProvidersAd.
        :rtype: bool
        """
    ...
    def restrict_findable(self, restrict_findable):
        """
        Sets the restrict_findable of this ProvidersAd.
        Check the provider for filtered lists of findable and unfindable users and groups.

        :param restrict_findable: The restrict_findable of this ProvidersAd.
        :type: bool
        """
    ...
    def sfu_support(self):
        """
        Gets the sfu_support of this ProvidersAd.
        Specifies whether to support RFC 2307 attributes on ADS domain controllers.

        :return: The sfu_support of this ProvidersAd.
        :rtype: str
        """
    ...
    def sfu_support(self, sfu_support):
        """
        Sets the sfu_support of this ProvidersAd.
        Specifies whether to support RFC 2307 attributes on ADS domain controllers.

        :param sfu_support: The sfu_support of this ProvidersAd.
        :type: str
        """
    ...
    def spns(self):
        """
        Gets the spns of this ProvidersAd.
        Currently configured SPNs.

        :return: The spns of this ProvidersAd.
        :rtype: list[str]
        """
        return self._spns
    ...
    def spns(self, spns):
        """
        Sets the spns of this ProvidersAd.
        Currently configured SPNs.

        :param spns: The spns of this ProvidersAd.
        :type: list[str]
        """
        self._spns = spns
    ...
    def store_sfu_mappings(self):
        """
        Gets the store_sfu_mappings of this ProvidersAd.
        Stores SFU mappings permanently in the ID mapper.

        :return: The store_sfu_mappings of this ProvidersAd.
        :rtype: bool
        """
    ...
    def store_sfu_mappings(self, store_sfu_mappings):
        """
        Sets the store_sfu_mappings of this ProvidersAd.
        Stores SFU mappings permanently in the ID mapper.

        :param store_sfu_mappings: The store_sfu_mappings of this ProvidersAd.
        :type: bool
        """
    ...
    def unfindable_groups(self):
        """
        Gets the unfindable_groups of this ProvidersAd.
        Specifies groups that cannot be resolved by the provider.

        :return: The unfindable_groups of this ProvidersAd.
        :rtype: list[str]
        """
    ...
    def unfindable_groups(self, unfindable_groups):
        """
        Sets the unfindable_groups of this ProvidersAd.
        Specifies groups that cannot be resolved by the provider.

        :param unfindable_groups: The unfindable_groups of this ProvidersAd.
        :type: list[str]
        """
    ...
    def unfindable_users(self):
        """
        Gets the unfindable_users of this ProvidersAd.
        Specifies users that cannot be resolved by the provider.

        :return: The unfindable_users of this ProvidersAd.
        :rtype: list[str]
        """
    ...
    def unfindable_users(self, unfindable_users):
        """
        Sets the unfindable_users of this ProvidersAd.
        Specifies users that cannot be resolved by the provider.

        :param unfindable_users: The unfindable_users of this ProvidersAd.
        :type: list[str]
        """
    ...
    def user(self, user):
        """
        Sets the user of this ProvidersAd.
        Specifies the user name that has permission to join a machine to the given domain.

        :param user: The user of this ProvidersAd.
        :type: str
        """
        self._user = user
