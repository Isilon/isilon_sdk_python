...
class EventCategoriesExtended(object):
    ...
    def __init__(self):
        """
        EventCategoriesExtended - a model defined in Swagger
    ...
    def resume(self):
        """
        Gets the resume of this EventCategoriesExtended.
        Continue returning results from previous call using this token (token should come from the previous call, resume cannot be used with other options).

        :return: The resume of this EventCategoriesExtended.
        :rtype: str
        """
        return self._resume
    ...
    def total(self):
        """
        Gets the total of this EventCategoriesExtended.
        Total number of items available.

        :return: The total of this EventCategoriesExtended.
        :rtype: int
        """
        return self._total
