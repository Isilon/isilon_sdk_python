...
class DedupeSettingsExtended(object):
    ...
    def __init__(self):
        """
        DedupeSettingsExtended - a model defined in Swagger
    ...
    def assess_paths(self):
        """
        Gets the assess_paths of this DedupeSettingsExtended.
        The paths that will be assessed.

        :return: The assess_paths of this DedupeSettingsExtended.
        :rtype: list[str]
        """
    ...
    def paths(self):
        """
        Gets the paths of this DedupeSettingsExtended.
        The paths that will be deduped.

        :return: The paths of this DedupeSettingsExtended.
        :rtype: list[str]
        """
        return self._paths
