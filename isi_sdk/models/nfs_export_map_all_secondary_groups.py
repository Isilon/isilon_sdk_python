...
class NfsExportMapAllSecondaryGroups(object):
    ...
    def __init__(self):
        """
        NfsExportMapAllSecondaryGroups - a model defined in Swagger
    ...
    def id(self):
        """
        Gets the id of this NfsExportMapAllSecondaryGroups.
        Specifies the serialized form of a persona, which can be 'UID:0', 'USER:name', 'GID:0', 'GROUP:wheel', or 'SID:S-1-1'.

        :return: The id of this NfsExportMapAllSecondaryGroups.
        :rtype: str
        """
        return self._id
    ...
    def type(self):
        """
        Gets the type of this NfsExportMapAllSecondaryGroups.
        Specifies the type of persona, which must be combined with a name.

        :return: The type of this NfsExportMapAllSecondaryGroups.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        ...
        :param type: The type of this NfsExportMapAllSecondaryGroups.
        :type: str
        """
