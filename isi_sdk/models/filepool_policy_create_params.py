...
class FilepoolPolicyCreateParams(object):
    ...
    def __init__(self):
        """
        FilepoolPolicyCreateParams - a model defined in Swagger
    ...
    def actions(self):
        """
        Gets the actions of this FilepoolPolicyCreateParams.
        A list of actions to be taken for matching files

        :return: The actions of this FilepoolPolicyCreateParams.
    ...
    def actions(self, actions):
        ...
        :param actions: The actions of this FilepoolPolicyCreateParams.
    ...
    def apply_order(self):
        """
        Gets the apply_order of this FilepoolPolicyCreateParams.
        The order in which this policy should be applied (relative to other policies)

        :return: The apply_order of this FilepoolPolicyCreateParams.
        :rtype: int
        """
    ...
    def apply_order(self, apply_order):
        ...
        :param apply_order: The apply_order of this FilepoolPolicyCreateParams.
        :type: int
        """
    ...
    def description(self):
        """
        Gets the description of this FilepoolPolicyCreateParams.
        A description for this policy

        :return: The description of this FilepoolPolicyCreateParams.
        :rtype: str
        """
    ...
    def description(self, description):
        ...
        :param description: The description of this FilepoolPolicyCreateParams.
        :type: str
        """
    ...
    def file_matching_pattern(self):
        """
        Gets the file_matching_pattern of this FilepoolPolicyCreateParams.
        The file matching rules for this policy

        :return: The file_matching_pattern of this FilepoolPolicyCreateParams.
    ...
    def file_matching_pattern(self, file_matching_pattern):
        ...
        :param file_matching_pattern: The file_matching_pattern of this FilepoolPolicyCreateParams.
    ...
    def name(self):
        """
        Gets the name of this FilepoolPolicyCreateParams.
        A unique name for this policy

        :return: The name of this FilepoolPolicyCreateParams.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this FilepoolPolicyCreateParams.
        :type: str
        """
