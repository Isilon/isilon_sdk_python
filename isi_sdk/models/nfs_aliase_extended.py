...
class NfsAliaseExtended(object):
    ...
    def __init__(self):
        """
        NfsAliaseExtended - a model defined in Swagger
    ...
    def health(self):
        """
        Gets the health of this NfsAliaseExtended.
        Specifies whether the alias is usable.

        :return: The health of this NfsAliaseExtended.
        :rtype: str
        """
        return self._health
    ...
    def health(self, health):
        """
        Sets the health of this NfsAliaseExtended.
        Specifies whether the alias is usable.

        :param health: The health of this NfsAliaseExtended.
        :type: str
        """
    ...
    def path(self):
        """
        Gets the path of this NfsAliaseExtended.
        Specifies the path to which the alias points.

        :return: The path of this NfsAliaseExtended.
        :rtype: str
        """
        return self._path
    ...
    def path(self, path):
        """
        Sets the path of this NfsAliaseExtended.
        Specifies the path to which the alias points.
    ...
    def zone(self):
        """
        Gets the zone of this NfsAliaseExtended.
        Specifies the zone in which the alias is valid.

        :return: The zone of this NfsAliaseExtended.
        :rtype: str
        """
        return self._zone
    ...
    def zone(self, zone):
        """
        Sets the zone of this NfsAliaseExtended.
        Specifies the zone in which the alias is valid.
