...
class SnapshotSchedulesExtended(object):
    ...
    def __init__(self):
        """
        SnapshotSchedulesExtended - a model defined in Swagger
    ...
    def resume(self):
        """
        Gets the resume of this SnapshotSchedulesExtended.
        Resume token value to use in subsequent calls for continuation.

        :return: The resume of this SnapshotSchedulesExtended.
        :rtype: str
        """
        return self._resume
    ...
    def total(self):
        """
        Gets the total of this SnapshotSchedulesExtended.
        Total number of items available.

        :return: The total of this SnapshotSchedulesExtended.
        :rtype: int
        """
        return self._total
