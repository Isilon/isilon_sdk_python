...
class AntivirusServerExtended(object):
    ...
    def __init__(self):
        """
        AntivirusServerExtended - a model defined in Swagger
    ...
    def description(self):
        """
        Gets the description of this AntivirusServerExtended.
        A description for the server.

        :return: The description of this AntivirusServerExtended.
        :rtype: str
        """
    ...
    def enabled(self):
        """
        Gets the enabled of this AntivirusServerExtended.
        Whether the server is enabled.

        :return: The enabled of this AntivirusServerExtended.
        :rtype: bool
        """
    ...
    def url(self):
        """
        Gets the url of this AntivirusServerExtended.
        The icap url for the server.  This should have a format of: icap://host.domain:port/path

        :return: The url of this AntivirusServerExtended.
        :rtype: str
        """
        return self._url
    ...
    def status(self):
        """
        Gets the status of this AntivirusServerExtended.
        The status of the server.

        :return: The status of this AntivirusServerExtended.
        :rtype: str
        """
        return self._status
