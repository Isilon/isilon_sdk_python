...
class SyncPoliciesExtended(object):
    ...
    def __init__(self):
        """
        SyncPoliciesExtended - a model defined in Swagger
    ...
    def policies(self):
        """
        Gets the policies of this SyncPoliciesExtended.
    ...
    def resume(self):
        """
        Gets the resume of this SyncPoliciesExtended.
        Continue returning results from previous call using this token (token should come from the previous call, resume cannot be used with other options).

        :return: The resume of this SyncPoliciesExtended.
        :rtype: str
        """
        return self._resume
    ...
    def resume(self, resume):
        ...
        :param resume: The resume of this SyncPoliciesExtended.
        :type: str
        """
    ...
    def total(self):
        """
        Gets the total of this SyncPoliciesExtended.
        Total number of items available.

        :return: The total of this SyncPoliciesExtended.
        :rtype: int
        """
        return self._total
    ...
    def total(self, total):
        ...
        :param total: The total of this SyncPoliciesExtended.
        :type: int
        """
