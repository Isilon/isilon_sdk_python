...
class NfsSettingsExport(object):
    ...
    def __init__(self):
        """
        NfsSettingsExport - a model defined in Swagger
    ...
    def settings(self):
        """
        Gets the settings of this NfsSettingsExport.
        Specifies configuration values for NFS exports.

        :return: The settings of this NfsSettingsExport.
    ...
    def settings(self, settings):
        ...
        :param settings: The settings of this NfsSettingsExport.
