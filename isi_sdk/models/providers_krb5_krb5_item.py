...
class ProvidersKrb5Krb5Item(object):
    ...
    def __init__(self):
        """
        ProvidersKrb5Krb5Item - a model defined in Swagger
    ...
    def groupnet(self):
        """
        Gets the groupnet of this ProvidersKrb5Krb5Item.
        Groupnet identifier.

        :return: The groupnet of this ProvidersKrb5Krb5Item.
        :rtype: str
        """
    ...
    def id(self):
        """
        Gets the id of this ProvidersKrb5Krb5Item.
        Specifies the Kerberos provider ID.

        :return: The id of this ProvidersKrb5Krb5Item.
        :rtype: str
        """
        return self._id
    ...
    def keytab_entries(self):
        """
        Gets the keytab_entries of this ProvidersKrb5Krb5Item.
        Specifies the key information for the Kerberos SPNs.

        :return: The keytab_entries of this ProvidersKrb5Krb5Item.
    ...
    def keytab_file(self):
        """
        Gets the keytab_file of this ProvidersKrb5Krb5Item.
        Specifies the path to a keytab file to import.

        :return: The keytab_file of this ProvidersKrb5Krb5Item.
        :rtype: str
        """
    ...
    def manual_keying(self):
        """
        Gets the manual_keying of this ProvidersKrb5Krb5Item.
        If true, keys are managed manually. If false, keys are managed through kadmin.

        :return: The manual_keying of this ProvidersKrb5Krb5Item.
        :rtype: bool
        """
    ...
    def name(self):
        """
        Gets the name of this ProvidersKrb5Krb5Item.
        Specifies the Kerberos provider name.

        :return: The name of this ProvidersKrb5Krb5Item.
        :rtype: str
        """
        return self._name
    ...
    def realm(self):
        """
        Gets the realm of this ProvidersKrb5Krb5Item.
        Specifies the name of realm.

        :return: The realm of this ProvidersKrb5Krb5Item.
        :rtype: str
        """
        return self._realm
    ...
    def recommended_spns(self):
        """
        Gets the recommended_spns of this ProvidersKrb5Krb5Item.
        Specifies the recommended SPNs.

        :return: The recommended_spns of this ProvidersKrb5Krb5Item.
        :rtype: list[str]
        """
    ...
    def status(self):
        """
        Gets the status of this ProvidersKrb5Krb5Item.
        Specifies the status of the provider.

        :return: The status of this ProvidersKrb5Krb5Item.
        :rtype: str
        """
        return self._status
    ...
    def system(self):
        """
        Gets the system of this ProvidersKrb5Krb5Item.
        If true, indicates that this provider instance was created by OneFS and cannot be removed

        :return: The system of this ProvidersKrb5Krb5Item.
        :rtype: bool
        """
        return self._system
    ...
    def user(self):
        """
        Gets the user of this ProvidersKrb5Krb5Item.
        Specifies the name of the user that performs kadmin tasks.

        :return: The user of this ProvidersKrb5Krb5Item.
        :rtype: str
        """
        return self._user
