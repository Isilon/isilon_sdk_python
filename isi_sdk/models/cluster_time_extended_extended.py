...
class ClusterTimeExtendedExtended(object):
    ...
    def __init__(self):
        """
        ClusterTimeExtendedExtended - a model defined in Swagger
    ...
    def time(self):
        """
        Gets the time of this ClusterTimeExtendedExtended.
        The current time on the cluster as a UNIX epoch (seconds since 1/1/1970), as reported by this node.

        :return: The time of this ClusterTimeExtendedExtended.
        :rtype: int
        """
        return self._time
    ...
    def time(self, time):
        ...
        :param time: The time of this ClusterTimeExtendedExtended.
        :type: int
        """
