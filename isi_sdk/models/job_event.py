...
class JobEvent(object):
    ...
    def __init__(self):
        """
        JobEvent - a model defined in Swagger
    ...
    def flags(self):
        """
        Gets the flags of this JobEvent.
        Event flags.

        :return: The flags of this JobEvent.
        :rtype: str
        """
        return self._flags
    ...
    def id(self):
        """
        Gets the id of this JobEvent.
        Job event ID.

        :return: The id of this JobEvent.
        :rtype: str
        """
        return self._id
    ...
    def job_id(self):
        """
        Gets the job_id of this JobEvent.
        Job ID.

        :return: The job_id of this JobEvent.
        :rtype: int
        """
        return self._job_id
    ...
    def job_type(self):
        """
        Gets the job_type of this JobEvent.
        Job Type.

        :return: The job_type of this JobEvent.
        :rtype: str
        """
    ...
    def key(self):
        """
        Gets the key of this JobEvent.
        Event key name.

        :return: The key of this JobEvent.
        :rtype: str
        """
        return self._key
    ...
    def phase(self):
        """
        Gets the phase of this JobEvent.
        Job phase number at time of event.

        :return: The phase of this JobEvent.
        :rtype: int
        """
        return self._phase
    ...
    def time(self):
        """
        Gets the time of this JobEvent.
        Time of event in Unix epoch seconds.

        :return: The time of this JobEvent.
        :rtype: int
        """
        return self._time
    ...
    def value(self):
        """
        Gets the value of this JobEvent.
        Event value.

        :return: The value of this JobEvent.
        :rtype: str
        """
        return self._value
