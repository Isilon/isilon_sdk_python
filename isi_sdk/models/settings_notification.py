...
class SettingsNotification(object):
    ...
    def __init__(self):
        """
        SettingsNotification - a model defined in Swagger
    ...
    def action_alert(self):
        """
        Gets the action_alert of this SettingsNotification.
        Send alert when rule matches.

        :return: The action_alert of this SettingsNotification.
        :rtype: bool
        """
    ...
    def action_alert(self, action_alert):
        """
        Sets the action_alert of this SettingsNotification.
        Send alert when rule matches.
    ...
    def action_email_address(self):
        """
        Gets the action_email_address of this SettingsNotification.
        Email a specific email address when rule matches.

        :return: The action_email_address of this SettingsNotification.
        :rtype: str
        """
    ...
    def action_email_address(self, action_email_address):
        """
        Sets the action_email_address of this SettingsNotification.
        Email a specific email address when rule matches.
    ...
    def action_email_owner(self):
        """
        Gets the action_email_owner of this SettingsNotification.
        Email quota domain owner when rule matches.

        :return: The action_email_owner of this SettingsNotification.
        :rtype: bool
        """
    ...
    def action_email_owner(self, action_email_owner):
        """
        Sets the action_email_owner of this SettingsNotification.
        Email quota domain owner when rule matches.
    ...
    def condition(self):
        """
        Gets the condition of this SettingsNotification.
        The condition detected.

        :return: The condition of this SettingsNotification.
        :rtype: str
        """
    ...
    def condition(self, condition):
        """
        Sets the condition of this SettingsNotification.
        The condition detected.

        :param condition: The condition of this SettingsNotification.
        :type: str
        """
    ...
    def email_template(self):
        """
        Gets the email_template of this SettingsNotification.
        Path of optional /ifs template file used for email actions.

        :return: The email_template of this SettingsNotification.
        :rtype: str
        """
    ...
    def email_template(self, email_template):
        """
        Sets the email_template of this SettingsNotification.
        Path of optional /ifs template file used for email actions.
    ...
    def holdoff(self):
        """
        Gets the holdoff of this SettingsNotification.
        Time to wait between detections for rules triggered by user actions.

        :return: The holdoff of this SettingsNotification.
        :rtype: int
        """
    ...
    def holdoff(self, holdoff):
        """
        Sets the holdoff of this SettingsNotification.
        Time to wait between detections for rules triggered by user actions.
    ...
    def schedule(self):
        """
        Gets the schedule of this SettingsNotification.
        Schedule for rules that repeatedly notify.

        :return: The schedule of this SettingsNotification.
        :rtype: str
        """
    ...
    def schedule(self, schedule):
        """
        Sets the schedule of this SettingsNotification.
        Schedule for rules that repeatedly notify.
    ...
    def threshold(self):
        """
        Gets the threshold of this SettingsNotification.
        The quota threshold detected.

        :return: The threshold of this SettingsNotification.
        :rtype: str
        """
    ...
    def threshold(self, threshold):
        """
        Sets the threshold of this SettingsNotification.
        The quota threshold detected.

        :param threshold: The threshold of this SettingsNotification.
        :type: str
        """
