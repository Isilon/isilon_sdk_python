...
from isi_sdk_8_1_1.models.smb_share_extended import SmbShareExtended  # noqa: F401,E501
from isi_sdk_8_1_1.models.smb_shares import SmbShares  # noqa: F401,E501
...
class SmbSharesExtended(object):
    ...
    def digest(self, digest):
        ...
        :type: str
        """
        if digest is not None and len(digest) > 256:
        ...
        if digest is not None and not re.search('^$|.', digest):  # noqa: E501
            raise ValueError("Invalid value for `digest`, must be a follow pattern or equal to `/^$|./`")  # noqa: E501
