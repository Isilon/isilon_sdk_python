...
class SnapshotApi(object):
    ...
    def get_changelists_changelist_lins(self, changelist, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_changelists_changelist_lins(changelist, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str changelist:  (required)
        :return: ChangelistsChangelistLinsExtended
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_changelists_changelist_lins" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('changelist' not in params) or (params['changelist'] is None):
            raise ValueError("Missing the required parameter `changelist` when calling `get_changelists_changelist_lins`")
        ...
        response = self.api_client.call_api(resource_path, method,
                                            ...
                                            post_params=form_params,
                                            files=files,
                                            response_type='ChangelistsChangelistLinsExtended',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_changelists_changelist_lin(self, changelists_changelist_lin_id, changelist, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_changelists_changelist_lin(changelists_changelist_lin_id, changelist, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int changelists_changelist_lin_id: Get a single entry from the changelist. (required)
        :param str changelist:  (required)
        :return: ChangelistsChangelistLins
                 If the method is called asynchronously,
                 returns the request thread.
        """

        all_params = ['changelists_changelist_lin_id', 'changelist']
        all_params.append('callback')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_changelists_changelist_lin" % key
                )
            params[key] = val
        del params['kwargs']

        # verify the required parameter 'changelists_changelist_lin_id' is set
        if ('changelists_changelist_lin_id' not in params) or (params['changelists_changelist_lin_id'] is None):
            raise ValueError("Missing the required parameter `changelists_changelist_lin_id` when calling `get_changelists_changelist_lin`")
        # verify the required parameter 'changelist' is set
        if ('changelist' not in params) or (params['changelist'] is None):
            raise ValueError("Missing the required parameter `changelist` when calling `get_changelists_changelist_lin`")

        resource_path = '/platform/1/snapshot/changelists/{Changelist}/lins/{ChangelistsChangelistLinId}'.replace('{format}', 'json')
        method = 'GET'

        path_params = {}
        if 'changelists_changelist_lin_id' in params:
            path_params['ChangelistsChangelistLinId'] = params['changelists_changelist_lin_id']
        if 'changelist' in params:
            path_params['Changelist'] = params['changelist']
        ...
        response = self.api_client.call_api(resource_path, method,
                                            ...
                                            post_params=form_params,
                                            files=files,
                                            response_type='ChangelistsChangelistLins',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def list_snapshots_sid_locks(self, sid, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_snapshots_sid_locks(sid, callback=callback_function)
        ...
        :param str dir: The direction of the sort.
        :param str resume: Continue returning results from previous call using this token (token should come from the previous call, resume cannot be used with other options).
        :return: SnapshotsSidLocksExtended
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_snapshots_sid_locks" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('sid' not in params) or (params['sid'] is None):
            raise ValueError("Missing the required parameter `sid` when calling `list_snapshots_sid_locks`")
        ...
        response = self.api_client.call_api(resource_path, method,
                                            ...
                                            post_params=form_params,
                                            files=files,
                                            response_type='SnapshotsSidLocksExtended',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def create_snapshots_sid_lock(self, snapshots_sid_lock, sid, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_snapshots_sid_lock(snapshots_sid_lock, sid, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param SnapshotsSidLockCreateParams snapshots_sid_lock:  (required)
        :param str sid:  (required)
        :return: CreateSnapshotsSidLockResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """

        all_params = ['snapshots_sid_lock', 'sid']
        all_params.append('callback')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_snapshots_sid_lock" % key
                )
            params[key] = val
        del params['kwargs']

        # verify the required parameter 'snapshots_sid_lock' is set
        if ('snapshots_sid_lock' not in params) or (params['snapshots_sid_lock'] is None):
            raise ValueError("Missing the required parameter `snapshots_sid_lock` when calling `create_snapshots_sid_lock`")
        # verify the required parameter 'sid' is set
        if ('sid' not in params) or (params['sid'] is None):
            raise ValueError("Missing the required parameter `sid` when calling `create_snapshots_sid_lock`")
        ...
        body_params = None
        if 'snapshots_sid_lock' in params:
            body_params = params['snapshots_sid_lock']
    ...
    def delete_snapshots_sid_locks(self, sid, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_snapshots_sid_locks(sid, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_snapshots_sid_locks" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'sid' is set
        if ('sid' not in params) or (params['sid'] is None):
            raise ValueError("Missing the required parameter `sid` when calling `delete_snapshots_sid_locks`")
    ...
    def get_snapshots_sid_lock(self, snapshots_sid_lock_id, sid, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_snapshots_sid_lock(snapshots_sid_lock_id, sid, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str snapshots_sid_lock_id: Retrieve lock information. (required)
        :param str sid:  (required)
        :return: SnapshotsSidLocks
                 If the method is called asynchronously,
                 returns the request thread.
        """

        all_params = ['snapshots_sid_lock_id', 'sid']
        all_params.append('callback')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_snapshots_sid_lock" % key
                )
            params[key] = val
        del params['kwargs']

        # verify the required parameter 'snapshots_sid_lock_id' is set
        if ('snapshots_sid_lock_id' not in params) or (params['snapshots_sid_lock_id'] is None):
            raise ValueError("Missing the required parameter `snapshots_sid_lock_id` when calling `get_snapshots_sid_lock`")
        # verify the required parameter 'sid' is set
        if ('sid' not in params) or (params['sid'] is None):
            raise ValueError("Missing the required parameter `sid` when calling `get_snapshots_sid_lock`")

        resource_path = '/platform/1/snapshot/snapshots/{Sid}/locks/{SnapshotsSidLockId}'.replace('{format}', 'json')
        method = 'GET'

        path_params = {}
        if 'snapshots_sid_lock_id' in params:
            path_params['SnapshotsSidLockId'] = params['snapshots_sid_lock_id']
        if 'sid' in params:
            path_params['Sid'] = params['sid']
        ...
        response = self.api_client.call_api(resource_path, method,
                                            ...
                                            post_params=form_params,
                                            files=files,
                                            response_type='SnapshotsSidLocks',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def update_snapshots_sid_lock(self, snapshots_sid_lock, snapshots_sid_lock_id, sid, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_snapshots_sid_lock(snapshots_sid_lock, snapshots_sid_lock_id, sid, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param SnapshotsSidLock snapshots_sid_lock:  (required)
        :param str snapshots_sid_lock_id: Modify lock. All input fields are optional, but one or more must be supplied. (required)
        :param str sid:  (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        all_params = ['snapshots_sid_lock', 'snapshots_sid_lock_id', 'sid']
        all_params.append('callback')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_snapshots_sid_lock" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'snapshots_sid_lock' is set
        if ('snapshots_sid_lock' not in params) or (params['snapshots_sid_lock'] is None):
            raise ValueError("Missing the required parameter `snapshots_sid_lock` when calling `update_snapshots_sid_lock`")
        # verify the required parameter 'snapshots_sid_lock_id' is set
        if ('snapshots_sid_lock_id' not in params) or (params['snapshots_sid_lock_id'] is None):
            raise ValueError("Missing the required parameter `snapshots_sid_lock_id` when calling `update_snapshots_sid_lock`")
        # verify the required parameter 'sid' is set
        if ('sid' not in params) or (params['sid'] is None):
            raise ValueError("Missing the required parameter `sid` when calling `update_snapshots_sid_lock`")
    ...
    def delete_snapshots_sid_lock(self, snapshots_sid_lock_id, sid, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_snapshots_sid_lock(snapshots_sid_lock_id, sid, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str snapshots_sid_lock_id: Delete the snapshot lock. (required)
        :param str sid:  (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_snapshots_sid_lock" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'snapshots_sid_lock_id' is set
        if ('snapshots_sid_lock_id' not in params) or (params['snapshots_sid_lock_id'] is None):
            raise ValueError("Missing the required parameter `snapshots_sid_lock_id` when calling `delete_snapshots_sid_lock`")
        # verify the required parameter 'sid' is set
        if ('sid' not in params) or (params['sid'] is None):
            raise ValueError("Missing the required parameter `sid` when calling `delete_snapshots_sid_lock`")
