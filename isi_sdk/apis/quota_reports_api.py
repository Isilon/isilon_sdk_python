...
class QuotaReportsApi(object):
    ...
    def get_report_about(self, rid, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_report_about(rid, callback=callback_function)
        ...
        if ('rid' not in params) or (params['rid'] is None):
            raise ValueError("Missing the required parameter `rid` when calling `get_report_about`")
