...
from isi_sdk_8_2_0.models.dedupe_settings_settings import DedupeSettingsSettings  # noqa: E501
...
class TestDedupeSettingsSettings(unittest.TestCase):
    ...
    def testDedupeSettingsSettings(self):
        ...
        # model = isi_sdk_8_2_0.models.dedupe_settings_settings.DedupeSettingsSettings()  # noqa: E501
        pass
