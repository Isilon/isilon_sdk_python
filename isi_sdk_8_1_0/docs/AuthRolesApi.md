...
api_instance = isi_sdk_8_1_0.AuthRolesApi(isi_sdk_8_1_0.ApiClient(configuration))
role_member = isi_sdk_8_1_0.AuthAccessAccessItemFileGroup() # AuthAccessAccessItemFileGroup | 
...
# create an instance of the API class
api_instance = isi_sdk_8_1_0.AuthRolesApi(isi_sdk_8_1_0.ApiClient(configuration))
role_privilege = isi_sdk_8_1_0.AuthIdNtokenPrivilegeItem() # AuthIdNtokenPrivilegeItem | 
role = 'role_example' # str | 
