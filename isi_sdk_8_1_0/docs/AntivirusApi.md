...
api_instance = isi_sdk_8_1_0.AntivirusApi(isi_sdk_8_1_0.ApiClient(configuration))
antivirus_policy = isi_sdk_8_1_0.AntivirusPolicyCreateParams() # AntivirusPolicyCreateParams | 
...
# create an instance of the API class
api_instance = isi_sdk_8_1_0.AntivirusApi(isi_sdk_8_1_0.ApiClient(configuration))
antivirus_scan_item = isi_sdk_8_1_0.AntivirusScanItem() # AntivirusScanItem | 
...
# create an instance of the API class
api_instance = isi_sdk_8_1_0.AntivirusApi(isi_sdk_8_1_0.ApiClient(configuration))
antivirus_server = isi_sdk_8_1_0.AntivirusServerCreateParams() # AntivirusServerCreateParams | 
...
# create an instance of the API class
api_instance = isi_sdk_8_1_0.AntivirusApi(isi_sdk_8_1_0.ApiClient(configuration))
antivirus_policy = isi_sdk_8_1_0.AntivirusPolicy() # AntivirusPolicy | 
...
# create an instance of the API class
api_instance = isi_sdk_8_1_0.AntivirusApi(isi_sdk_8_1_0.ApiClient(configuration))
antivirus_quarantine_path_params = isi_sdk_8_1_0.AntivirusQuarantinePathParams() # AntivirusQuarantinePathParams | 
...
# create an instance of the API class
api_instance = isi_sdk_8_1_0.AntivirusApi(isi_sdk_8_1_0.ApiClient(configuration))
antivirus_server = isi_sdk_8_1_0.AntivirusServer() # AntivirusServer | 
...
# create an instance of the API class
api_instance = isi_sdk_8_1_0.AntivirusApi(isi_sdk_8_1_0.ApiClient(configuration))
antivirus_settings = isi_sdk_8_1_0.AntivirusSettingsSettings() # AntivirusSettingsSettings | 
