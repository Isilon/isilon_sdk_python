# isi_sdk_8_1_1.SnapshotSnapshotsApi
...
api_instance = isi_sdk_8_1_1.SnapshotSnapshotsApi(isi_sdk_8_1_1.ApiClient(configuration))
snapshot_lock = isi_sdk_8_1_1.SnapshotLockCreateParams() # SnapshotLockCreateParams | 
sid = 'sid_example' # str | 
...
# create an instance of the API class
api_instance = isi_sdk_8_1_1.SnapshotSnapshotsApi(isi_sdk_8_1_1.ApiClient(configuration))
snapshot_lock = isi_sdk_8_1_1.SnapshotLock() # SnapshotLock | 
