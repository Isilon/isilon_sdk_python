...
from isi_sdk_8_1_1.models.smb_share_permission import SmbSharePermission  # noqa: F401,E501
...
class SmbShareCreateParams(object):
    ...
    def description(self, description):
        ...
        if description is not None and not re.search('^$|.', description):  # noqa: E501
            raise ValueError("Invalid value for `description`, must be a follow pattern or equal to `/^$|./`")  # noqa: E501
    ...
    def path(self, path):
        ...
        if path is not None and not re.search('^$|.', path):  # noqa: E501
            raise ValueError("Invalid value for `path`, must be a follow pattern or equal to `/^$|./`")  # noqa: E501
