# isi_sdk_8_2_2.NetworkGroupnetsSubnetsApi
...
api_instance = isi_sdk_8_2_2.NetworkGroupnetsSubnetsApi(isi_sdk_8_2_2.ApiClient(configuration))
pools_pool_rebalance_ip = isi_sdk_8_2_2.Empty() # Empty | 
...
# create an instance of the API class
api_instance = isi_sdk_8_2_2.NetworkGroupnetsSubnetsApi(isi_sdk_8_2_2.ApiClient(configuration))
pools_pool_rule = isi_sdk_8_2_2.PoolsPoolRuleCreateParams() # PoolsPoolRuleCreateParams | 
groupnet = 'groupnet_example' # str | 
subnet = 'subnet_example' # str | 
pool = 'pool_example' # str | 
...
# create an instance of the API class
api_instance = isi_sdk_8_2_2.NetworkGroupnetsSubnetsApi(isi_sdk_8_2_2.ApiClient(configuration))
pools_pool_sc_resume_node = isi_sdk_8_2_2.PoolsPoolScResumeNode() # PoolsPoolScResumeNode | 
groupnet = 'groupnet_example' # str | 
subnet = 'subnet_example' # str | 
pool = 'pool_example' # str | 
...
# create an instance of the API class
api_instance = isi_sdk_8_2_2.NetworkGroupnetsSubnetsApi(isi_sdk_8_2_2.ApiClient(configuration))
pools_pool_sc_suspend_node = isi_sdk_8_2_2.PoolsPoolScResumeNode() # PoolsPoolScResumeNode | 
groupnet = 'groupnet_example' # str | 
subnet = 'subnet_example' # str | 
pool = 'pool_example' # str | 
...
# create an instance of the API class
api_instance = isi_sdk_8_2_2.NetworkGroupnetsSubnetsApi(isi_sdk_8_2_2.ApiClient(configuration))
pools_pool_rule = isi_sdk_8_2_2.PoolsPoolRule() # PoolsPoolRule | 
