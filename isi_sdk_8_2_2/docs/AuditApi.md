...
api_instance = isi_sdk_8_2_2.AuditApi(isi_sdk_8_2_2.ApiClient(configuration))
audit_topic = isi_sdk_8_2_2.AuditTopicCreateParams() # AuditTopicCreateParams | 
...
# create an instance of the API class
api_instance = isi_sdk_8_2_2.AuditApi(isi_sdk_8_2_2.ApiClient(configuration))
audit_settings = isi_sdk_8_2_2.AuditSettingsSettings() # AuditSettingsSettings | 
zone = 'zone_example' # str | Access zone which contains audit settings. (optional)
...
# create an instance of the API class
api_instance = isi_sdk_8_2_2.AuditApi(isi_sdk_8_2_2.ApiClient(configuration))
audit_topic = isi_sdk_8_2_2.AuditTopic() # AuditTopic | 
...
# create an instance of the API class
api_instance = isi_sdk_8_2_2.AuditApi(isi_sdk_8_2_2.ApiClient(configuration))
settings_global = isi_sdk_8_2_2.SettingsGlobalSettings() # SettingsGlobalSettings | 
