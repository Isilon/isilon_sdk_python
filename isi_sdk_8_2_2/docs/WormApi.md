...
api_instance = isi_sdk_8_2_2.WormApi(isi_sdk_8_2_2.ApiClient(configuration))
worm_domain = isi_sdk_8_2_2.WormDomainCreateParams() # WormDomainCreateParams | 
...
# create an instance of the API class
api_instance = isi_sdk_8_2_2.WormApi(isi_sdk_8_2_2.ApiClient(configuration))
worm_domain = isi_sdk_8_2_2.WormDomain() # WormDomain | 
...
# create an instance of the API class
api_instance = isi_sdk_8_2_2.WormApi(isi_sdk_8_2_2.ApiClient(configuration))
worm_settings = isi_sdk_8_2_2.WormSettingsExtended() # WormSettingsExtended | 
