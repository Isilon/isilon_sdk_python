...
class FsaResultsApi(object):
    ...
    def get_result_dir_pools_usage(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_result_dir_pools_usage(id, async=True)
        >>> result = thread.get()
    ...
    def get_result_dir_pools_usage_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_result_dir_pools_usage_with_http_info(id, async=True)
        >>> result = thread.get()
    ...
    def get_result_dir_pools_usage_lin(self, result_dir_pools_usage_lin, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_result_dir_pools_usage_lin(result_dir_pools_usage_lin, id, async=True)
        >>> result = thread.get()
    ...
    def get_result_dir_pools_usage_lin_with_http_info(self, result_dir_pools_usage_lin, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_result_dir_pools_usage_lin_with_http_info(result_dir_pools_usage_lin, id, async=True)
        >>> result = thread.get()
