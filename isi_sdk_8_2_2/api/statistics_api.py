...
class StatisticsApi(object):
    ...
    def get_summary_workload(self, **kwargs):  # noqa: E501
        ...
        :param str protocols: A comma separated list. Default is all. (smb1, smb2, nfs3 and nfs4 only at this time.)
    ...
    def get_summary_workload_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['group_sids', 'numeric', 'export_ids', 'degraded', 'remote_names', 'share_names', 'paths', 'usernames', 'remote_addresses', 'job_types', 'zone_ids', 'groupnames', 'nodes', 'sort', 'domain_ids', 'zone_names', 'local_names', 'user_ids', 'totalby', 'local_addresses', 'dataset', 'user_sids', 'protocols', 'group_ids', 'timeout', 'system_names']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            '/platform/9/statistics/summary/workload', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
