...
class DedupeApi(object):
    ...
    def get_inline_settings(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_inline_settings(async=True)
        >>> result = thread.get()
    ...
    def get_inline_settings_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_inline_settings_with_http_info(async=True)
        >>> result = thread.get()
    ...
    def update_inline_settings(self, inline_settings, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_inline_settings(inline_settings, async=True)
        >>> result = thread.get()
    ...
    def update_inline_settings_with_http_info(self, inline_settings, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_inline_settings_with_http_info(inline_settings, async=True)
        >>> result = thread.get()
