# isilon_sdk.v9_2_0.FileFilterApi
...
api_instance = isilon_sdk.v9_2_0.FileFilterApi(isilon_sdk.v9_2_0.ApiClient(configuration))
...
# create an instance of the API class
api_instance = isilon_sdk.v9_2_0.FileFilterApi(isilon_sdk.v9_2_0.ApiClient(configuration))
file_filter_settings = isilon_sdk.v9_2_0.FileFilterSettingsExtended() # FileFilterSettingsExtended | 
zone = 'zone_example' # str | Specifies the access zones in which these settings apply. (optional)
