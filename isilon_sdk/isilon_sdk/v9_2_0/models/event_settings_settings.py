...
class EventSettingsSettings(object):
    ...
    def retention_days(self, retention_days):
        ...
        :type: int
        """
        if retention_days is not None and retention_days > 9223372036854775807:  # noqa: E501
            raise ValueError("Invalid value for `retention_days`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
