...
class HardeningStateState(object):
    ...
    def issues_file(self):
        ...
        Full contents name of issues file, or null if no issues file is configured. This file contains all issues found when the cluster configuration is checked against expected configuration.  # noqa: E501
