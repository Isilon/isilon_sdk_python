...
class SettingsGlobalGlobalSettings(object):
    ...
    def concurrent_session_limit(self, concurrent_session_limit):
        ...
        :type: int
        """
        if concurrent_session_limit is not None and concurrent_session_limit > 65535:  # noqa: E501
            raise ValueError("Invalid value for `concurrent_session_limit`, must be a value less than or equal to `65535`")  # noqa: E501
        if concurrent_session_limit is not None and concurrent_session_limit < 0:  # noqa: E501
    ...
    def failed_login_delay_time(self, failed_login_delay_time):
        ...
        :type: int
        """
        if failed_login_delay_time is not None and failed_login_delay_time > 65535:  # noqa: E501
            raise ValueError("Invalid value for `failed_login_delay_time`, must be a value less than or equal to `65535`")  # noqa: E501
        if failed_login_delay_time is not None and failed_login_delay_time < 0:  # noqa: E501
