...
class EventAlertCondition(object):
    ...
    def __init__(self, categories=None, channels=None, condition=None, eventgroup_ids=None, exclude_eventgroup_ids=None, interval=None, limit=None, severities=None, transient=None):  # noqa: E501
