...
class FtpSettingsSettings(object):
    ...
    def anon_chown_username(self, anon_chown_username):
        ...
        :type: str
        """
        if anon_chown_username is not None and len(anon_chown_username) > 255:
            raise ValueError("Invalid value for `anon_chown_username`, length must be less than or equal to `255`")  # noqa: E501
        if anon_chown_username is not None and len(anon_chown_username) < 0:
    ...
    def anon_root_path(self, anon_root_path):
        ...
        :type: str
        """
        if anon_root_path is not None and len(anon_root_path) > 4096:
            raise ValueError("Invalid value for `anon_root_path`, length must be less than or equal to `4096`")  # noqa: E501
        if anon_root_path is not None and len(anon_root_path) < 0:
    ...
    def local_root_path(self, local_root_path):
        ...
        :type: str
        """
        if local_root_path is not None and len(local_root_path) > 4096:
            raise ValueError("Invalid value for `local_root_path`, length must be less than or equal to `4096`")  # noqa: E501
        if local_root_path is not None and len(local_root_path) < 0:
    ...
    def user_config_dir(self, user_config_dir):
        ...
        :type: str
        """
        if user_config_dir is not None and len(user_config_dir) > 4096:
            raise ValueError("Invalid value for `user_config_dir`, length must be less than or equal to `4096`")  # noqa: E501
        if user_config_dir is not None and len(user_config_dir) < 0:
