...
from isilon_sdk.v9_5_0.models.storagepool_settings_settings_spillover_target import StoragepoolSettingsSettingsSpilloverTarget  # noqa: F401,E501
...
class StoragepoolSettingsSettings(object):
    ...
    def default_transfer_limit_pct(self, default_transfer_limit_pct):
        ...
        :type: float
        """
        if default_transfer_limit_pct is not None and default_transfer_limit_pct > 100:  # noqa: E501
            raise ValueError("Invalid value for `default_transfer_limit_pct`, must be a value less than or equal to `100`")  # noqa: E501
        if default_transfer_limit_pct is not None and default_transfer_limit_pct < 0:  # noqa: E501
    ...
    def default_transfer_limit_state(self, default_transfer_limit_state):
        ...
        if default_transfer_limit_state not in allowed_values:
            raise ValueError(
