...
class NodeStatusNvramNode(object):
    ...
    def __init__(self, batteries=None, battery_count=None, charge_status=None, charge_status_number=None, error=None, id=None, lnn=None, present=None, present_flash=None, present_size=None, present_type=None, status=None, supported=None, supported_flash=None, supported_type=None):  # noqa: E501
