...
from isilon_sdk.v9_5_0.models.node_drives_node_drive_firmware import NodeDrivesNodeDriveFirmware  # noqa: F401,E501
...
class NodeDrivesNodeDrive(object):
    ...
    def media_class(self, media_class):
        ...
        :type: str
        """
        if media_class is not None and len(media_class) > 255:
            raise ValueError("Invalid value for `media_class`, length must be less than or equal to `255`")  # noqa: E501
        if media_class is not None and len(media_class) < 0:
