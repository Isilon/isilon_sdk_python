...
class StoragepoolNodepoolCreateParams(object):
    ...
    def __init__(self, l3=None, lnns=None, name=None, protection_policy=None, sjm_enabled=None, tier=None, transfer_limit_pct=None, transfer_limit_state=None):  # noqa: E501
