...
class DatamoverAccountExtended(object):
    ...
    def __init__(self, account_type=None, briefcase=None, credentials=None, enforce_sse=None, id=None, local_network_pool=None, max_sparks=None, name=None, remote_network_pool=None, storage_class=None, uri=None, version=None):  # noqa: E501
    ...
    def local_network_pool(self, local_network_pool):
        ...
        if local_network_pool is not None and len(local_network_pool) < 0:
    ...
    def remote_network_pool(self, remote_network_pool):
        ...
        if remote_network_pool is not None and len(remote_network_pool) < 0:
