...
**sc_service_addrs** | [**list[GroupnetSubnetScServiceAddr]**](GroupnetSubnetScServiceAddr.md) | List of IP addresses that SmartConnect listens for DNS requests. | [optional] 
