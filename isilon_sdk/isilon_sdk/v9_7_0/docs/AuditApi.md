...
api_instance = isilon_sdk.v9_7_0.AuditApi(isilon_sdk.v9_7_0.ApiClient(configuration))
audit_topic = isilon_sdk.v9_7_0.AuditTopicCreateParams() # AuditTopicCreateParams | 
...
# create an instance of the API class
api_instance = isilon_sdk.v9_7_0.AuditApi(isilon_sdk.v9_7_0.ApiClient(configuration))
certificates_syslog_item = isilon_sdk.v9_7_0.CertificatesSyslogItem() # CertificatesSyslogItem | 
...
# create an instance of the API class
api_instance = isilon_sdk.v9_7_0.AuditApi(isilon_sdk.v9_7_0.ApiClient(configuration))
audit_settings = isilon_sdk.v9_7_0.AuditSettingsSettings() # AuditSettingsSettings | 
zone = 'zone_example' # str | Access zone which contains audit settings. (optional)
...
# create an instance of the API class
api_instance = isilon_sdk.v9_7_0.AuditApi(isilon_sdk.v9_7_0.ApiClient(configuration))
audit_topic = isilon_sdk.v9_7_0.AuditTopic() # AuditTopic | 
...
# create an instance of the API class
api_instance = isilon_sdk.v9_7_0.AuditApi(isilon_sdk.v9_7_0.ApiClient(configuration))
certificates_syslog_id_params = isilon_sdk.v9_7_0.CertificatesSyslogIdParams() # CertificatesSyslogIdParams | 
...
# create an instance of the API class
api_instance = isilon_sdk.v9_7_0.AuditApi(isilon_sdk.v9_7_0.ApiClient(configuration))
settings_global = isilon_sdk.v9_7_0.SettingsGlobalSettings() # SettingsGlobalSettings | 
force = true # bool | Do not ask for confirmation. (optional)
