# isilon_sdk.v9_7_0.NetworkGroupnetsApi
...
[**create_subnets_subnet_pool**](NetworkGroupnetsApi.md#create_subnets_subnet_pool) | **POST** /platform/18/network/groupnets/{Groupnet}/subnets/{Subnet}/pools | 
...
[**delete_subnets_subnet_pool**](NetworkGroupnetsApi.md#delete_subnets_subnet_pool) | **DELETE** /platform/18/network/groupnets/{Groupnet}/subnets/{Subnet}/pools/{SubnetsSubnetPoolId} | 
...
[**get_subnets_subnet_pool**](NetworkGroupnetsApi.md#get_subnets_subnet_pool) | **GET** /platform/18/network/groupnets/{Groupnet}/subnets/{Subnet}/pools/{SubnetsSubnetPoolId} | 
[**list_groupnet_subnets**](NetworkGroupnetsApi.md#list_groupnet_subnets) | **GET** /platform/16/network/groupnets/{Groupnet}/subnets | 
[**list_subnets_subnet_pools**](NetworkGroupnetsApi.md#list_subnets_subnet_pools) | **GET** /platform/18/network/groupnets/{Groupnet}/subnets/{Subnet}/pools | 
...
[**update_subnets_subnet_pool**](NetworkGroupnetsApi.md#update_subnets_subnet_pool) | **PUT** /platform/18/network/groupnets/{Groupnet}/subnets/{Subnet}/pools/{SubnetsSubnetPoolId} | 
...
api_instance = isilon_sdk.v9_7_0.NetworkGroupnetsApi(isilon_sdk.v9_7_0.ApiClient(configuration))
groupnet_subnet = isilon_sdk.v9_7_0.GroupnetSubnetCreateParams() # GroupnetSubnetCreateParams | 
...
# create an instance of the API class
api_instance = isilon_sdk.v9_7_0.NetworkGroupnetsApi(isilon_sdk.v9_7_0.ApiClient(configuration))
subnets_subnet_pool = isilon_sdk.v9_7_0.SubnetsSubnetPoolCreateParams() # SubnetsSubnetPoolCreateParams | 
groupnet = 'groupnet_example' # str | 
...
# create an instance of the API class
api_instance = isilon_sdk.v9_7_0.NetworkGroupnetsApi(isilon_sdk.v9_7_0.ApiClient(configuration))
groupnet_subnet = isilon_sdk.v9_7_0.GroupnetSubnet() # GroupnetSubnet | 
...
# create an instance of the API class
api_instance = isilon_sdk.v9_7_0.NetworkGroupnetsApi(isilon_sdk.v9_7_0.ApiClient(configuration))
subnets_subnet_pool = isilon_sdk.v9_7_0.SubnetsSubnetPool() # SubnetsSubnetPool | 
