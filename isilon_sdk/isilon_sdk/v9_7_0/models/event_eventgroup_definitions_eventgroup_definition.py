...
class EventEventgroupDefinitionsEventgroupDefinition(object):
    ...
    def __init__(self, category=None, channels=None, description=None, id=None, name=None, no_ignore=None, node=None, rules=None, suppressed=None, ui_name=None):  # noqa: E501
