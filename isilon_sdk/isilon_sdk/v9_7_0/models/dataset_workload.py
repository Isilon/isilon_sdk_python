...
class DatasetWorkload(object):
    ...
    def __init__(self, client_impact=None, cluster_resource_impact=None, limits=None, max_cpu_us=None, max_disk_reads=None, max_disk_writes=None, name=None):  # noqa: E501
