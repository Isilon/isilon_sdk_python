...
class NodeDriveconfigNode(object):
    ...
    def __init__(self, alert=None, allow=None, automatic_replacement_recognition=None, error=None, id=None, instant_secure_erase=None, lnn=None, log=None, reboot=None, spin_wait=None, stall=None, status=None):  # noqa: E501
    ...
    @property
    def error(self):
        """Gets the error of this NodeDriveconfigNode.  # noqa: E501

        Error message, if the HTTP status returned from this node was not 200.  # noqa: E501

        :return: The error of this NodeDriveconfigNode.  # noqa: E501
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        """Sets the error of this NodeDriveconfigNode.

        Error message, if the HTTP status returned from this node was not 200.  # noqa: E501

        :param error: The error of this NodeDriveconfigNode.  # noqa: E501
        :type: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this NodeDriveconfigNode.  # noqa: E501

        Status of the HTTP response from this node if not 200.  If 200, this field does not appear.  # noqa: E501

        :return: The status of this NodeDriveconfigNode.  # noqa: E501
        :rtype: int
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this NodeDriveconfigNode.

        Status of the HTTP response from this node if not 200.  If 200, this field does not appear.  # noqa: E501

        :param status: The status of this NodeDriveconfigNode.  # noqa: E501
        :type: int
        """
