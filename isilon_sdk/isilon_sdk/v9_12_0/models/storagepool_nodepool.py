...
class StoragepoolNodepool(object):
    ...
    def __init__(self, assess=None, l3=None, lnns=None, name=None, node_type_ids=None, protection_policy=None, sjm_enabled=None, tier=None, transfer_limit_pct=None, transfer_limit_state=None):  # noqa: E501
