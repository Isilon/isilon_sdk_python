...
class SedStatusNode(object):
    ...
    @property
    def error(self):
        """Gets the error of this SedStatusNode.  # noqa: E501

        Error message, if the HTTP status returned from this node was not 200.  # noqa: E501

        :return: The error of this SedStatusNode.  # noqa: E501
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        """Sets the error of this SedStatusNode.

        Error message, if the HTTP status returned from this node was not 200.  # noqa: E501

        :param error: The error of this SedStatusNode.  # noqa: E501
        :type: str
        """
