...
class ClusterNode(object):
    ...
    def __init__(self, drive_d_config=None, drives=None, error=None, hardware=None, id=None, internal_ip_address=None, lnn=None, partitions=None, sensors=None, sleds=None, state=None, status=None):  # noqa: E501
    ...
    @property
    def error(self):
        """Gets the error of this ClusterNode.  # noqa: E501

        Error message, if the HTTP status returned from this node was not 200.  # noqa: E501

        :return: The error of this ClusterNode.  # noqa: E501
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        """Sets the error of this ClusterNode.

        Error message, if the HTTP status returned from this node was not 200.  # noqa: E501

        :param error: The error of this ClusterNode.  # noqa: E501
        :type: str
        """
