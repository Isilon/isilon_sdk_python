...
class CreateSnapshotSnapshotResponse(object):
    ...
    def path(self, path):
        ...
        if path is not None and not re.search('^\/ifs$|^\/ifs\/|^LIVE$', path):  # noqa: E501
    ...
    def shadow_bytes(self, shadow_bytes):
        ...
        if shadow_bytes is not None and shadow_bytes > 9223372036854775807:  # noqa: E501
            raise ValueError("Invalid value for `shadow_bytes`, must be a value less than or equal to `9223372036854775807`")  # noqa: E501
        if shadow_bytes is not None and shadow_bytes < 0:  # noqa: E501
            raise ValueError("Invalid value for `shadow_bytes`, must be a value greater than or equal to `0`")  # noqa: E501
