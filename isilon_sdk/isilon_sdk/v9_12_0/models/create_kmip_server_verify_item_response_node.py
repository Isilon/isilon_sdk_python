...
class CreateKmipServerVerifyItemResponseNode(object):
    ...
    def __init__(self, error=None, id=None, lnn=None, message=None, status=None):  # noqa: E501
    ...
    @property
    def error(self):
        """Gets the error of this CreateKmipServerVerifyItemResponseNode.  # noqa: E501

        Error message, if the HTTP status returned from this node was not 200.  # noqa: E501

        :return: The error of this CreateKmipServerVerifyItemResponseNode.  # noqa: E501
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        """Sets the error of this CreateKmipServerVerifyItemResponseNode.

        Error message, if the HTTP status returned from this node was not 200.  # noqa: E501

        :param error: The error of this CreateKmipServerVerifyItemResponseNode.  # noqa: E501
        :type: str
        """
