...
class SedStatusNodeExtended(object):
    ...
    def __init__(self, error=None, error_msg=None, id=None, key_timestamp=None, lnn=None, location=None, remote_key_id=None, status=None):  # noqa: E501
    ...
    @property
    def error(self):
        """Gets the error of this SedStatusNodeExtended.  # noqa: E501

        Error message, if the HTTP status returned from this node was not 200.  # noqa: E501

        :return: The error of this SedStatusNodeExtended.  # noqa: E501
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        """Sets the error of this SedStatusNodeExtended.

        Error message, if the HTTP status returned from this node was not 200.  # noqa: E501

        :param error: The error of this SedStatusNodeExtended.  # noqa: E501
        :type: str
        """
