...
class NdmpSettingsGlobalGlobal(object):
    ...
    swagger_types = {
        ...
        'check_tape_position_redirection': 'bool',
        'dma': 'str',
    ...
    attribute_map = {
        ...
        'check_tape_position_redirection': 'check_tape_position_redirection',
        'dma': 'dma',
    ...
    def __init__(self, bre_max_num_contexts=None, check_tape_position_redirection=None, dma=None, enable_redirector=None, enable_throttler=None, msb_context_retention_duration=None, msr_context_retention_duration=None, port=None, service=None, stub_file_open_timeout=None, throttler_cpu_threshold=None, vmem_size=None):  # noqa: E501
        """NdmpSettingsGlobalGlobal - a model defined in Swagger"""  # noqa: E501

        self._bre_max_num_contexts = None
        self._check_tape_position_redirection = None
        self._dma = None
        ...
        if check_tape_position_redirection is not None:
            self.check_tape_position_redirection = check_tape_position_redirection
        if dma is not None:
            self.dma = dma
    ...
    @property
    def check_tape_position_redirection(self):
        """Gets the check_tape_position_redirection of this NdmpSettingsGlobalGlobal.  # noqa: E501

        enable/disable NDMP check of tape position for redirection.  # noqa: E501

        :return: The check_tape_position_redirection of this NdmpSettingsGlobalGlobal.  # noqa: E501
        :rtype: bool
        """
        return self._check_tape_position_redirection

    @check_tape_position_redirection.setter
    def check_tape_position_redirection(self, check_tape_position_redirection):
        """Sets the check_tape_position_redirection of this NdmpSettingsGlobalGlobal.

        enable/disable NDMP check of tape position for redirection.  # noqa: E501

        :param check_tape_position_redirection: The check_tape_position_redirection of this NdmpSettingsGlobalGlobal.  # noqa: E501
        :type: bool
        """

        self._check_tape_position_redirection = check_tape_position_redirection
    ...
    def vmem_size(self, vmem_size):
        ...
        :type: int
        """
        if vmem_size is not None and vmem_size > 8192:  # noqa: E501
            raise ValueError("Invalid value for `vmem_size`, must be a value less than or equal to `8192`")  # noqa: E501
        if vmem_size is not None and vmem_size < 512:  # noqa: E501
