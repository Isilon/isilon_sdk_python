...
class S3SettingsZoneSettings(object):
    ...
    swagger_types = {
        ...
        'compliance_clock_support': 'bool',
        'default_lock_protection_mode': 'str',
        'object_acl_policy': 'str',
        'object_lock_support': 'bool',
        'root_path': 'str',
        'syslog_access_logging': 'bool',
    ...
    attribute_map = {
        ...
        'compliance_clock_support': 'compliance_clock_support',
        'default_lock_protection_mode': 'default_lock_protection_mode',
        'object_acl_policy': 'object_acl_policy',
        'object_lock_support': 'object_lock_support',
        'root_path': 'root_path',
        'syslog_access_logging': 'syslog_access_logging',
        'use_md5_for_etag': 'use_md5_for_etag',
        'validate_content_md5': 'validate_content_md5'
    }

    def __init__(self, base_domain=None, bucket_directory_create_mode=None, compliance_clock_support=None, default_lock_protection_mode=None, object_acl_policy=None, object_lock_support=None, root_path=None, syslog_access_logging=None, use_md5_for_etag=None, validate_content_md5=None):  # noqa: E501
        """S3SettingsZoneSettings - a model defined in Swagger"""  # noqa: E501

        self._base_domain = None
        self._bucket_directory_create_mode = None
        self._compliance_clock_support = None
        self._default_lock_protection_mode = None
        self._object_acl_policy = None
        self._object_lock_support = None
        self._root_path = None
        self._syslog_access_logging = None
        ...
        if compliance_clock_support is not None:
            self.compliance_clock_support = compliance_clock_support
        if default_lock_protection_mode is not None:
            self.default_lock_protection_mode = default_lock_protection_mode
        if object_acl_policy is not None:
            self.object_acl_policy = object_acl_policy
        if object_lock_support is not None:
            self.object_lock_support = object_lock_support
        if root_path is not None:
            self.root_path = root_path
        if syslog_access_logging is not None:
            self.syslog_access_logging = syslog_access_logging
    ...
    @property
    def compliance_clock_support(self):
        """Gets the compliance_clock_support of this S3SettingsZoneSettings.  # noqa: E501

        Enable compliance clock support  # noqa: E501

        :return: The compliance_clock_support of this S3SettingsZoneSettings.  # noqa: E501
        :rtype: bool
        """
        return self._compliance_clock_support

    @compliance_clock_support.setter
    def compliance_clock_support(self, compliance_clock_support):
        """Sets the compliance_clock_support of this S3SettingsZoneSettings.

        Enable compliance clock support  # noqa: E501

        :param compliance_clock_support: The compliance_clock_support of this S3SettingsZoneSettings.  # noqa: E501
        :type: bool
        """

        self._compliance_clock_support = compliance_clock_support

    @property
    def default_lock_protection_mode(self):
        """Gets the default_lock_protection_mode of this S3SettingsZoneSettings.  # noqa: E501

        Lock protection mode for S3 bucket  # noqa: E501

        :return: The default_lock_protection_mode of this S3SettingsZoneSettings.  # noqa: E501
        :rtype: str
        """
        return self._default_lock_protection_mode

    @default_lock_protection_mode.setter
    def default_lock_protection_mode(self, default_lock_protection_mode):
        """Sets the default_lock_protection_mode of this S3SettingsZoneSettings.

        Lock protection mode for S3 bucket  # noqa: E501

        :param default_lock_protection_mode: The default_lock_protection_mode of this S3SettingsZoneSettings.  # noqa: E501
        :type: str
        """
        allowed_values = ["ObjectLock", "BucketLock"]  # noqa: E501
        if default_lock_protection_mode not in allowed_values:
            raise ValueError(
                "Invalid value for `default_lock_protection_mode` ({0}), must be one of {1}"  # noqa: E501
                .format(default_lock_protection_mode, allowed_values)
            )

        self._default_lock_protection_mode = default_lock_protection_mode
    ...
    @property
    def object_lock_support(self):
        """Gets the object_lock_support of this S3SettingsZoneSettings.  # noqa: E501

        Toggle Object Lock support  # noqa: E501

        :return: The object_lock_support of this S3SettingsZoneSettings.  # noqa: E501
        :rtype: bool
        """
        return self._object_lock_support

    @object_lock_support.setter
    def object_lock_support(self, object_lock_support):
        """Sets the object_lock_support of this S3SettingsZoneSettings.

        Toggle Object Lock support  # noqa: E501

        :param object_lock_support: The object_lock_support of this S3SettingsZoneSettings.  # noqa: E501
        :type: bool
        """

        self._object_lock_support = object_lock_support
    ...
    @property
    def syslog_access_logging(self):
        """Gets the syslog_access_logging of this S3SettingsZoneSettings.  # noqa: E501

        Toggle syslog access logging support  # noqa: E501

        :return: The syslog_access_logging of this S3SettingsZoneSettings.  # noqa: E501
        :rtype: bool
        """
        return self._syslog_access_logging

    @syslog_access_logging.setter
    def syslog_access_logging(self, syslog_access_logging):
        """Sets the syslog_access_logging of this S3SettingsZoneSettings.

        Toggle syslog access logging support  # noqa: E501

        :param syslog_access_logging: The syslog_access_logging of this S3SettingsZoneSettings.  # noqa: E501
        :type: bool
        """

        self._syslog_access_logging = syslog_access_logging
