...
class NodeHardwareNode(object):
    ...
    def __init__(self, chassis=None, chassis_code=None, chassis_depth=None, _class=None, compute_type=None, configuration_id=None, cpu=None, disk_controller=None, disk_expander=None, error=None, family_code=None, generation_code=None, hwgen=None, id=None, infiniband=None, lcd_version=None, lnn=None, model=None, model_code=None, motherboard=None, net_interfaces=None, node_id=None, node_slot_id=None, nvram=None, peer_serial_number=None, performance_code=None, powersupplies=None, processor=None, product=None, ram=None, region=None, resource_group=None, serial_number=None, series=None, sled_drive_count=None, status=None, storage_class=None, subscription_id=None, tier=None, top_level_assembly_serial_number=None, volume_type=None):  # noqa: E501
    ...
    @property
    def error(self):
        """Gets the error of this NodeHardwareNode.  # noqa: E501

        Error message, if the HTTP status returned from this node was not 200.  # noqa: E501

        :return: The error of this NodeHardwareNode.  # noqa: E501
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        """Sets the error of this NodeHardwareNode.

        Error message, if the HTTP status returned from this node was not 200.  # noqa: E501

        :param error: The error of this NodeHardwareNode.  # noqa: E501
        :type: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this NodeHardwareNode.  # noqa: E501

        Status of the HTTP response from this node if not 200.  If 200, this field does not appear.  # noqa: E501

        :return: The status of this NodeHardwareNode.  # noqa: E501
        :rtype: int
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this NodeHardwareNode.

        Status of the HTTP response from this node if not 200.  If 200, this field does not appear.  # noqa: E501

        :param status: The status of this NodeHardwareNode.  # noqa: E501
        :type: int
        """
