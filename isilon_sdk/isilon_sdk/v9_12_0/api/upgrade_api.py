...
class UpgradeApi(object):
    ...
    def create_package_download_by_id(self, package_download_id, package_download_id2, **kwargs):  # noqa: E501
        """create_package_download_by_id  # noqa: E501

        Download the package file for the specified package ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_package_download_by_id(package_download_id, package_download_id2, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Empty package_download_id: (required)
        :param str package_download_id2: Download the package file for the specified package ID. (required)
        :return: Empty
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_package_download_by_id_with_http_info(package_download_id, package_download_id2, **kwargs)  # noqa: E501
        else:
            (data) = self.create_package_download_by_id_with_http_info(package_download_id, package_download_id2, **kwargs)  # noqa: E501
            return data

    def create_package_download_by_id_with_http_info(self, package_download_id, package_download_id2, **kwargs):  # noqa: E501
        """create_package_download_by_id  # noqa: E501

        Download the package file for the specified package ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_package_download_by_id_with_http_info(package_download_id, package_download_id2, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['package_download_id', 'package_download_id2']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_package_download_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'package_download_id' is set
        if ('package_download_id' not in params or
                params['package_download_id'] is None):
            raise ValueError("Missing the required parameter `package_download_id` when calling `create_package_download_by_id`")  # noqa: E501
        # verify the required parameter 'package_download_id2' is set
        if ('package_download_id2' not in params or
                params['package_download_id2'] is None):
            raise ValueError("Missing the required parameter `package_download_id2` when calling `create_package_download_by_id`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'package_download_id2' in params:
            path_params['PackageDownloadId'] = params['package_download_id2']  # noqa: E501
        ...
        body_params = None
        if 'package_download_id' in params:
            body_params = params['package_download_id']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/23/upgrade/package/download/{PackageDownloadId}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_package_download_by_id(self, package_download_id, **kwargs):  # noqa: E501
        """delete_package_download_by_id  # noqa: E501

        Delete downloaded package files per package ID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_package_download_by_id(package_download_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str package_download_id: Delete downloaded package files per package ID (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_package_download_by_id_with_http_info(package_download_id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_package_download_by_id_with_http_info(package_download_id, **kwargs)  # noqa: E501
            return data

    def delete_package_download_by_id_with_http_info(self, package_download_id, **kwargs):  # noqa: E501
        """delete_package_download_by_id  # noqa: E501

        Delete downloaded package files per package ID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_package_download_by_id_with_http_info(package_download_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['package_download_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_package_download_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'package_download_id' is set
        if ('package_download_id' not in params or
                params['package_download_id'] is None):
            raise ValueError("Missing the required parameter `package_download_id` when calling `delete_package_download_by_id`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'package_download_id' in params:
            path_params['PackageDownloadId'] = params['package_download_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/23/upgrade/package/download/{PackageDownloadId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_package_package(self, package_package_id, **kwargs):  # noqa: E501
        """get_package_package  # noqa: E501

        The upgrade package infomation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_package_package(package_package_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str package_package_id: The upgrade package infomation. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_package_package_with_http_info(package_package_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_package_package_with_http_info(package_package_id, **kwargs)  # noqa: E501
            return data

    def get_package_package_with_http_info(self, package_package_id, **kwargs):  # noqa: E501
        """get_package_package  # noqa: E501

        The upgrade package infomation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_package_package_with_http_info(package_package_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['package_package_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_package_package" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'package_package_id' is set
        if ('package_package_id' not in params or
                params['package_package_id'] is None):
            raise ValueError("Missing the required parameter `package_package_id` when calling `get_package_package`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'package_package_id' in params:
            path_params['PackagePackageId'] = params['package_package_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/23/upgrade/package/packages/{PackagePackageId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='PackagePackages',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_package_packages(self, **kwargs):  # noqa: E501
        """get_package_packages  # noqa: E501

        List upgrade package info.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_package_packages(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str package_type: comma separated package types.
        :return: PackagePackagesExtended
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_package_packages_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_package_packages_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_package_packages_with_http_info(self, **kwargs):  # noqa: E501
        """get_package_packages  # noqa: E501

        List upgrade package info.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_package_packages_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_package_packages" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/platform/23/upgrade/package/packages', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='PackagePackagesExtended',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_package_settings(self, **kwargs):  # noqa: E501
        """get_package_settings  # noqa: E501

        Retrieve the upgrade package settings.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_package_settings(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_package_settings_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_package_settings_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_package_settings_with_http_info(self, **kwargs):  # noqa: E501
        """get_package_settings  # noqa: E501

        Retrieve the upgrade package settings.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_package_settings_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_package_settings" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/platform/23/upgrade/package/settings', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='PackageSettings',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_package_settings(self, package_settings, **kwargs):  # noqa: E501
        """update_package_settings  # noqa: E501

        Modify the upgrade package settings.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_package_settings(package_settings, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param PackageSettingsSettings package_settings: (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_package_settings_with_http_info(package_settings, **kwargs)  # noqa: E501
        else:
            (data) = self.update_package_settings_with_http_info(package_settings, **kwargs)  # noqa: E501
            return data

    def update_package_settings_with_http_info(self, package_settings, **kwargs):  # noqa: E501
        """update_package_settings  # noqa: E501

        Modify the upgrade package settings.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_package_settings_with_http_info(package_settings, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['package_settings']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_package_settings" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'package_settings' is set
        if ('package_settings' not in params or
                params['package_settings'] is None):
            raise ValueError("Missing the required parameter `package_settings` when calling `update_package_settings`")  # noqa: E501
        ...
        body_params = None
        if 'package_settings' in params:
            body_params = params['package_settings']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/23/upgrade/package/settings', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
