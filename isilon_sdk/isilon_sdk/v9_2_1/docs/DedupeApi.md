...
api_instance = isilon_sdk.v9_2_1.DedupeApi(isilon_sdk.v9_2_1.ApiClient(configuration))
...
# create an instance of the API class
api_instance = isilon_sdk.v9_2_1.DedupeApi(isilon_sdk.v9_2_1.ApiClient(configuration))
dedupe_settings = isilon_sdk.v9_2_1.DedupeSettingsExtended() # DedupeSettingsExtended | 
...
# create an instance of the API class
api_instance = isilon_sdk.v9_2_1.DedupeApi(isilon_sdk.v9_2_1.ApiClient(configuration))
inline_settings = isilon_sdk.v9_2_1.InlineSettingsSettings() # InlineSettingsSettings | 
