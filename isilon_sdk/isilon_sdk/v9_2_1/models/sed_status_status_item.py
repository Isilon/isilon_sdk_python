...
class SedStatusStatusItem(object):
    ...
    def __init__(self, error_msg=None, location=None, remote_key_id=None, status=None):  # noqa: E501
        """SedStatusStatusItem - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def error_msg(self):
        """Gets the error_msg of this SedStatusStatusItem.  # noqa: E501

        information of the error if there is an error status. Empty if no error occurred.  # noqa: E501

        :return: The error_msg of this SedStatusStatusItem.  # noqa: E501
        :rtype: str
        """
    ...
    def error_msg(self, error_msg):
        """Sets the error_msg of this SedStatusStatusItem.

        information of the error if there is an error status. Empty if no error occurred.  # noqa: E501

        :param error_msg: The error_msg of this SedStatusStatusItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def location(self):
        """Gets the location of this SedStatusStatusItem.  # noqa: E501

        Current location of the key.  # noqa: E501

        :return: The location of this SedStatusStatusItem.  # noqa: E501
        :rtype: str
        """
    ...
    def location(self, location):
        """Sets the location of this SedStatusStatusItem.

        Current location of the key.  # noqa: E501

        :param location: The location of this SedStatusStatusItem.  # noqa: E501
        :type: str
        """
    ...
    def remote_key_id(self):
        """Gets the remote_key_id of this SedStatusStatusItem.  # noqa: E501

        Key ID in the remote KMIP server.  # noqa: E501

        :return: The remote_key_id of this SedStatusStatusItem.  # noqa: E501
        :rtype: str
        """
    ...
    def remote_key_id(self, remote_key_id):
        """Sets the remote_key_id of this SedStatusStatusItem.

        Key ID in the remote KMIP server.  # noqa: E501

        :param remote_key_id: The remote_key_id of this SedStatusStatusItem.  # noqa: E501
        :type: str
        """
    ...
    def status(self, status):
        """Sets the status of this SedStatusStatusItem.

        Current key migration status. If no SEDs are avaiable and KMIP is not supported, it will show OFFLINE status.  # noqa: E501

        :param status: The status of this SedStatusStatusItem.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SedStatusStatusItem):
            return False
