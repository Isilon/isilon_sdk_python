...
**disable_stf** | **bool** | NOTE: This field should not be changed without the help of PowerScale support.  Enable/disable the 6.5+ STF based data transfer and uses only treewalk. | [optional] 
**elliptic_curve_list** | **str** | The elliptic curve list being used with encryption. For SyncIQ targets, this list serves as a list of supported elliptic curves. For SyncIQ sources, the list of elliptic curves will be attempted to be used in order. | [optional] 
