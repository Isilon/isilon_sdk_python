...
class DrivesDriveFirmwareNodeDrive(object):
    ...
    def __init__(self, bay_group=None, baynum=None, current_firmware=None, desired_firmware=None, devname=None, lnum=None, locnstr=None, model=None):  # noqa: E501
    ...
    def bay_group(self, bay_group):
        ...
        :type: str
        """
        if bay_group is not None and len(bay_group) > 255:
