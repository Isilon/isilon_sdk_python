...
class NdmpSettingsGlobalGlobal(object):
    ...
    def __init__(self, bre_max_num_contexts=None, dma=None, enable_redirector=None, enable_throttler=None, msb_context_retention_duration=None, msr_context_retention_duration=None, port=None, service=None, stub_file_open_timeout=None, throttler_cpu_threshold=None, vmem_size=None):  # noqa: E501
