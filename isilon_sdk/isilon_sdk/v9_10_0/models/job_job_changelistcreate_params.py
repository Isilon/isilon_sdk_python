...
class JobJobChangelistcreateParams(object):
    ...
    def __init__(self, create_diffs=None, newer_snapid=None, older_snapid=None, retain_repstate=None, track_data_location=None):  # noqa: E501
    ...
    def older_snapid(self, older_snapid):
        ...
        if older_snapid is not None and older_snapid < 0:  # noqa: E501
