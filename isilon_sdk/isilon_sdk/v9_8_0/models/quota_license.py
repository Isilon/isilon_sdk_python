...
class QuotaLicense(object):
    ...
    def expiration(self, expiration):
        ...
        if expiration is not None and not re.search(r'^\\d\\d\\d\\d-\\d\\d-\\d\\d$', expiration):  # noqa: E501
            raise ValueError(r"Invalid value for `expiration`, must be a follow pattern or equal to `/^\\d\\d\\d\\d-\\d\\d-\\d\\d$/`")  # noqa: E501
