...
api_instance = isilon_sdk.v9_9_0.PapiApi(isilon_sdk.v9_9_0.ApiClient(configuration))
...
# create an instance of the API class
api_instance = isilon_sdk.v9_9_0.PapiApi(isilon_sdk.v9_9_0.ApiClient(configuration))
papi_settings = isilon_sdk.v9_9_0.PapiSettingsExtended() # PapiSettingsExtended | 
