...
class DiagnosticsNetloggerStartItem(object):
    ...
    def __init__(self, clients=None, count=None, duration=None, interfaces=None, nodelist=None, ports=None, protocols=None, snaplength=None):  # noqa: E501
        """DiagnosticsNetloggerStartItem - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def clients(self):
        """Gets the clients of this DiagnosticsNetloggerStartItem.  # noqa: E501

        Limit packet collection to specified Client hostname/IP addresses.  # noqa: E501

        :return: The clients of this DiagnosticsNetloggerStartItem.  # noqa: E501
        :rtype: str
        """
    ...
    def clients(self, clients):
        """Sets the clients of this DiagnosticsNetloggerStartItem.
    ...
    @property
    def count(self):
        """Gets the count of this DiagnosticsNetloggerStartItem.  # noqa: E501
        ...
        :return: The count of this DiagnosticsNetloggerStartItem.  # noqa: E501
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        """Sets the count of this DiagnosticsNetloggerStartItem.

        The number of packet capture files to keep after they reach the duration limit.  Defaults to the latest 3 files.  0 is infinite.  # noqa: E501

        :param count: The count of this DiagnosticsNetloggerStartItem.  # noqa: E501
        :type: int
        """
    ...
    @property
    def duration(self):
        """Gets the duration of this DiagnosticsNetloggerStartItem.  # noqa: E501

        Duration in minutes of each capture file  # noqa: E501

        :return: The duration of this DiagnosticsNetloggerStartItem.  # noqa: E501
        :rtype: int
        """
    ...
    def duration(self, duration):
        """Sets the duration of this DiagnosticsNetloggerStartItem.

        Duration in minutes of each capture file  # noqa: E501

        :param duration: The duration of this DiagnosticsNetloggerStartItem.  # noqa: E501
        :type: int
        """
    ...
    @property
    def interfaces(self):
        """Gets the interfaces of this DiagnosticsNetloggerStartItem.  # noqa: E501

        Limit packet collection to specified network interfaces.  # noqa: E501

        :return: The interfaces of this DiagnosticsNetloggerStartItem.  # noqa: E501
        :rtype: str
        """
    ...
    def interfaces(self, interfaces):
        """Sets the interfaces of this DiagnosticsNetloggerStartItem.
    ...
    @property
    def nodelist(self):
        """Gets the nodelist of this DiagnosticsNetloggerStartItem.  # noqa: E501

        List of nodes specified by LNN on which to run the capture, or empty for all  # noqa: E501

        :return: The nodelist of this DiagnosticsNetloggerStartItem.  # noqa: E501
        :rtype: str
        """
    ...
    def nodelist(self, nodelist):
        """Sets the nodelist of this DiagnosticsNetloggerStartItem.
    ...
    @property
    def ports(self):
        """Gets the ports of this DiagnosticsNetloggerStartItem.  # noqa: E501

        Limit packet collection to specified TCP or UDP ports  # noqa: E501

        :return: The ports of this DiagnosticsNetloggerStartItem.  # noqa: E501
        :rtype: str
        """
        return self._ports
    ...
    def ports(self, ports):
        """Sets the ports of this DiagnosticsNetloggerStartItem.
    ...
    @property
    def protocols(self):
        """Gets the protocols of this DiagnosticsNetloggerStartItem.  # noqa: E501

        Limit packet collection to specified protocols  # noqa: E501

        :return: The protocols of this DiagnosticsNetloggerStartItem.  # noqa: E501
        :rtype: str
        """
    ...
    def protocols(self, protocols):
        """Sets the protocols of this DiagnosticsNetloggerStartItem.
    ...
    @property
    def snaplength(self):
        """Gets the snaplength of this DiagnosticsNetloggerStartItem.  # noqa: E501
        ...
        :return: The snaplength of this DiagnosticsNetloggerStartItem.  # noqa: E501
        :rtype: int
        """
    ...
    def snaplength(self, snaplength):
        """Sets the snaplength of this DiagnosticsNetloggerStartItem.

        The maximum amount of data for each packet that is captured.  Default is 320 bytes. Valid range is 64 to 9100 bytes  # noqa: E501

        :param snaplength: The snaplength of this DiagnosticsNetloggerStartItem.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DiagnosticsNetloggerStartItem):
            return False
