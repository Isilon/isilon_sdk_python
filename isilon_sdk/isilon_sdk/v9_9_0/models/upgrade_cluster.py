...
from isilon_sdk.v9_9_0.models.cluster_nodes_onefs_version import ClusterNodesOnefsVersion  # noqa: F401,E501
from isilon_sdk.v9_9_0.models.upgrade_cluster_cluster_overview import UpgradeClusterClusterOverview  # noqa: F401,E501
from isilon_sdk.v9_9_0.models.upgrade_cluster_committed_features import UpgradeClusterCommittedFeatures  # noqa: F401,E501
from isilon_sdk.v9_9_0.models.upgrade_cluster_upgrade_settings import UpgradeClusterUpgradeSettings  # noqa: F401,E501
...
class UpgradeCluster(object):
    ...
    def assessment_progress(self, assessment_progress):
        ...
        :type: int
        """
        if assessment_progress is not None and assessment_progress > 100:  # noqa: E501
            raise ValueError("Invalid value for `assessment_progress`, must be a value less than or equal to `100`")  # noqa: E501
        if assessment_progress is not None and assessment_progress < 0:  # noqa: E501
    ...
    def assessment_status(self, assessment_status):
        ...
        :type: str
        """
        if assessment_status is not None and len(assessment_status) > 128:
            raise ValueError("Invalid value for `assessment_status`, length must be less than or equal to `128`")  # noqa: E501
        if assessment_status is not None and len(assessment_status) < 0:
    ...
    def upgrade_triggered_time(self, upgrade_triggered_time):
        ...
        if upgrade_triggered_time is not None and len(upgrade_triggered_time) < 4:
