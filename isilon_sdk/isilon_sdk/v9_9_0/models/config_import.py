...
class ConfigImport(object):
    ...
    def __init__(self, done=None, export_id=None, failed=None, id=None, initiator=None, message=None, path=None, pending=None, skipped=None, status=None):  # noqa: E501
