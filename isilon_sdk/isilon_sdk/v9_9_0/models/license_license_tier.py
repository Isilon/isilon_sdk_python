...
from isilon_sdk.v9_9_0.models.license_license_tier_entitlements_exceeded_alert import LicenseLicenseTierEntitlementsExceededAlert  # noqa: F401,E501
...
class LicenseLicenseTier(object):
    ...
    def __init__(self, entitlements_exceeded_alerts=None, licensed_drive_capacity=None, licensed_node_count=None, licensed_nodes_with_seds_count=None, platform=None, tier=None, used_drive_capacity=None, used_node_count=None, used_nodes_with_seds_count=None):  # noqa: E501
    ...
    def platform(self, platform):
        ...
        :type: str
        """
        if platform is not None and len(platform) > 255:
    ...
    def tier(self, tier):
        ...
        if tier is not None and not re.search('^NONINF$|^NO_TIER$|^[0-9]+$', tier):  # noqa: E501
            raise ValueError("Invalid value for `tier`, must be a follow pattern or equal to `/^NONINF$|^NO_TIER$|^[0-9]+$/`")  # noqa: E501
