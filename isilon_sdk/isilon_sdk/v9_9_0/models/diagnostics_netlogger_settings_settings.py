...
class DiagnosticsNetloggerSettingsSettings(object):
    ...
    def protocols(self, protocols):
        ...
        :type: str
        """
        if protocols is not None and not re.search('^(ip6|ip|arp|tcp|udp|vlan)(,(ip6|ip|arp|tcp|udp|vlan))*$', protocols):  # noqa: E501
            raise ValueError("Invalid value for `protocols`, must be a follow pattern or equal to `/^(ip6|ip|arp|tcp|udp|vlan)(,(ip6|ip|arp|tcp|udp|vlan))*$/`")  # noqa: E501
