...
from isilon_sdk.v9_9_0.models.license_license_tier import LicenseLicenseTier  # noqa: F401,E501
...
class LicenseLicense(object):
    ...
    def expiration(self, expiration):
        ...
        if expiration is not None and not re.search('^[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]$', expiration):  # noqa: E501
            raise ValueError("Invalid value for `expiration`, must be a follow pattern or equal to `/^[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]$/`")  # noqa: E501
