...
class ProvidersSamlServicesSpExtended(object):
    ...
    def __init__(self, email=None, entity_id=None, first_name=None, hostname=None, last_name=None, name_id_format=None, signing_enabled=None, user_id=None):  # noqa: E501
    ...
    def name_id_format(self, name_id_format):
        ...
        if name_id_format not in allowed_values:
            raise ValueError(
