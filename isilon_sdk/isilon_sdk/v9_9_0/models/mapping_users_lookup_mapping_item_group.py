...
from isilon_sdk.v9_9_0.models.auth_group_object_history_item import AuthGroupObjectHistoryItem  # noqa: F401,E501
...
class MappingUsersLookupMappingItemGroup(object):
    ...
    def last_logon(self, last_logon):
        ...
        :type: int
        """
        if last_logon is not None and last_logon > 4294967295:  # noqa: E501
            raise ValueError("Invalid value for `last_logon`, must be a value less than or equal to `4294967295`")  # noqa: E501
        if last_logon is not None and last_logon < 0:  # noqa: E501
