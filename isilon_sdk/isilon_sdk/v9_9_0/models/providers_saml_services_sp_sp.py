...
class ProvidersSamlServicesSpSp(object):
    ...
    def __init__(self, acs_url=None, email=None, entity_id=None, first_name=None, hostname=None, last_name=None, login_url=None, logout_url=None, metadata_location=None, name_id_format=None, signing_certificate=None, signing_enabled=None, user_id=None):  # noqa: E501
