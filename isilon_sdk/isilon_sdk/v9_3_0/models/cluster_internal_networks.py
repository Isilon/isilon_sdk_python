...
from isilon_sdk.v9_3_0.models.config_network_network_range import ConfigNetworkNetworkRange  # noqa: F401,E501
...
class ClusterInternalNetworks(object):
    ...
    """
    swagger_types = {
        'failover_ip_addresses': 'list[ConfigNetworkNetworkRange]',
        'failover_status': 'str',
        'int_a_fabric': 'str',
        'int_a_ip_addresses': 'list[ConfigNetworkNetworkRange]',
        'int_a_mtu': 'int',
        'int_a_prefix_length': 'int',
        'int_a_status': 'str',
        'int_b_fabric': 'str',
        'int_b_ip_addresses': 'list[ConfigNetworkNetworkRange]',
        'int_b_mtu': 'int',
