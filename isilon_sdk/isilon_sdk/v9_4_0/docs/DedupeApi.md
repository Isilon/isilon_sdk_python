...
api_instance = isilon_sdk.v9_4_0.DedupeApi(isilon_sdk.v9_4_0.ApiClient(configuration))
...
# create an instance of the API class
api_instance = isilon_sdk.v9_4_0.DedupeApi(isilon_sdk.v9_4_0.ApiClient(configuration))
dedupe_settings = isilon_sdk.v9_4_0.DedupeSettingsExtended() # DedupeSettingsExtended | 
...
# create an instance of the API class
api_instance = isilon_sdk.v9_4_0.DedupeApi(isilon_sdk.v9_4_0.ApiClient(configuration))
inline_settings = isilon_sdk.v9_4_0.InlineSettingsSettings() # InlineSettingsSettings | 
