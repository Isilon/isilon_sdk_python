...
from isilon_sdk.v9_4_0.models.pools_pool_status_settings_node_interface_status import PoolsPoolStatusSettingsNodeInterfaceStatus  # noqa: F401,E501


class PoolsPoolStatusSettingsNode(object):
    ...
    swagger_types = {
        'devid': 'int',
        'interface_status': 'PoolsPoolStatusSettingsNodeInterfaceStatus',
        'ip_status': 'str',
        'lnn': 'int',
        'node_state': 'str',
    ...
    def __init__(self, devid=None, interface_status=None, ip_status=None, lnn=None, node_state=None, protocols_running=None, sc_dns_resolvable=None, suspended=None):  # noqa: E501
        """PoolsPoolStatusSettingsNode - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def devid(self):
        """Gets the devid of this PoolsPoolStatusSettingsNode.  # noqa: E501

        Node ID (Device Number) of a node.  # noqa: E501

        :return: The devid of this PoolsPoolStatusSettingsNode.  # noqa: E501
        :rtype: int
        """
        return self._devid
    ...
    def devid(self, devid):
        """Sets the devid of this PoolsPoolStatusSettingsNode.

        Node ID (Device Number) of a node.  # noqa: E501

        :param devid: The devid of this PoolsPoolStatusSettingsNode.  # noqa: E501
        :type: int
        """
    ...
    def interface_status(self):
        """Gets the interface_status of this PoolsPoolStatusSettingsNode.  # noqa: E501

          # noqa: E501

        :return: The interface_status of this PoolsPoolStatusSettingsNode.  # noqa: E501
        :rtype: PoolsPoolStatusSettingsNodeInterfaceStatus
        """
        return self._interface_status

    @interface_status.setter
    def interface_status(self, interface_status):
        """Sets the interface_status of this PoolsPoolStatusSettingsNode.

          # noqa: E501

        :param interface_status: The interface_status of this PoolsPoolStatusSettingsNode.  # noqa: E501
        :type: PoolsPoolStatusSettingsNodeInterfaceStatus
        """
    ...
    @property
    def ip_status(self):
        """Gets the ip_status of this PoolsPoolStatusSettingsNode.  # noqa: E501
        ...
        :return: The ip_status of this PoolsPoolStatusSettingsNode.  # noqa: E501
        :rtype: str
        """
    ...
    def ip_status(self, ip_status):
        """Sets the ip_status of this PoolsPoolStatusSettingsNode.

        Summary of the status of the IPs currently configured on this node. usable: The node has IPs allocated that are usable. none_usable: The node has IPs configured, but they are currently not in a usable state. This can occur for a variety of reasons. For static IPs, this can occur if the node is down, or if the interfaces are down. For dynamic IPs, this can occur if all of the IPs are about to move to a different node. none_configured: The node has no IPs from the Network Pool configured currently.  # noqa: E501

        :param ip_status: The ip_status of this PoolsPoolStatusSettingsNode.  # noqa: E501
        :type: str
        """
    ...
    @property
    def lnn(self):
        """Gets the lnn of this PoolsPoolStatusSettingsNode.  # noqa: E501

        Logical Node Number (LNN) of a node.  # noqa: E501

        :return: The lnn of this PoolsPoolStatusSettingsNode.  # noqa: E501
        :rtype: int
        """
        return self._lnn
    ...
    @lnn.setter
    def lnn(self, lnn):
        """Sets the lnn of this PoolsPoolStatusSettingsNode.

        Logical Node Number (LNN) of a node.  # noqa: E501

        :param lnn: The lnn of this PoolsPoolStatusSettingsNode.  # noqa: E501
        :type: int
        """
    ...
    @property
    def node_state(self):
        """Gets the node_state of this PoolsPoolStatusSettingsNode.  # noqa: E501

        The node's current state within the cluster.  # noqa: E501

        :return: The node_state of this PoolsPoolStatusSettingsNode.  # noqa: E501
        :rtype: str
        """
    ...
    def node_state(self, node_state):
        """Sets the node_state of this PoolsPoolStatusSettingsNode.

        The node's current state within the cluster.  # noqa: E501

        :param node_state: The node_state of this PoolsPoolStatusSettingsNode.  # noqa: E501
        :type: str
        """
    ...
    def protocols_running(self):
        """Gets the protocols_running of this PoolsPoolStatusSettingsNode.  # noqa: E501

        Indicates if the node has the required protocols to be resolvable via DNS.  # noqa: E501

        :return: The protocols_running of this PoolsPoolStatusSettingsNode.  # noqa: E501
        :rtype: bool
        """
    ...
    def protocols_running(self, protocols_running):
        """Sets the protocols_running of this PoolsPoolStatusSettingsNode.

        Indicates if the node has the required protocols to be resolvable via DNS.  # noqa: E501

        :param protocols_running: The protocols_running of this PoolsPoolStatusSettingsNode.  # noqa: E501
        :type: bool
        """
    ...
    def sc_dns_resolvable(self):
        """Gets the sc_dns_resolvable of this PoolsPoolStatusSettingsNode.  # noqa: E501

        Indicates if the node can be resolved via SmartConnect DNS or not.  # noqa: E501

        :return: The sc_dns_resolvable of this PoolsPoolStatusSettingsNode.  # noqa: E501
        :rtype: bool
        """
    ...
    def sc_dns_resolvable(self, sc_dns_resolvable):
        """Sets the sc_dns_resolvable of this PoolsPoolStatusSettingsNode.

        Indicates if the node can be resolved via SmartConnect DNS or not.  # noqa: E501

        :param sc_dns_resolvable: The sc_dns_resolvable of this PoolsPoolStatusSettingsNode.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def suspended(self):
        """Gets the suspended of this PoolsPoolStatusSettingsNode.  # noqa: E501

        Indicates if the node has been suspended within the Network Pool.  # noqa: E501

        :return: The suspended of this PoolsPoolStatusSettingsNode.  # noqa: E501
        :rtype: bool
        """
    ...
    def suspended(self, suspended):
        """Sets the suspended of this PoolsPoolStatusSettingsNode.

        Indicates if the node has been suspended within the Network Pool.  # noqa: E501

        :param suspended: The suspended of this PoolsPoolStatusSettingsNode.  # noqa: E501
        :type: bool
        """
