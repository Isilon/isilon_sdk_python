# isilon_sdk.v9_6_0.PerformanceDatasetsApi
...
[**create_dataset_workload**](PerformanceDatasetsApi.md#create_dataset_workload) | **POST** /platform/16/performance/datasets/{Dataset}/workloads | 
...
[**delete_dataset_workload**](PerformanceDatasetsApi.md#delete_dataset_workload) | **DELETE** /platform/16/performance/datasets/{Dataset}/workloads/{DatasetWorkloadId} | 
[**delete_dataset_workloads**](PerformanceDatasetsApi.md#delete_dataset_workloads) | **DELETE** /platform/16/performance/datasets/{Dataset}/workloads | 
...
[**get_dataset_workload**](PerformanceDatasetsApi.md#get_dataset_workload) | **GET** /platform/16/performance/datasets/{Dataset}/workloads/{DatasetWorkloadId} | 
[**list_dataset_filters**](PerformanceDatasetsApi.md#list_dataset_filters) | **GET** /platform/12/performance/datasets/{Dataset}/filters | 
[**list_dataset_workloads**](PerformanceDatasetsApi.md#list_dataset_workloads) | **GET** /platform/16/performance/datasets/{Dataset}/workloads | 
...
[**update_dataset_workload**](PerformanceDatasetsApi.md#update_dataset_workload) | **PUT** /platform/16/performance/datasets/{Dataset}/workloads/{DatasetWorkloadId} | 
...
api_instance = isilon_sdk.v9_6_0.PerformanceDatasetsApi(isilon_sdk.v9_6_0.ApiClient(configuration))
dataset_filter = isilon_sdk.v9_6_0.DatasetFilterCreateParams() # DatasetFilterCreateParams | 
...
# create an instance of the API class
api_instance = isilon_sdk.v9_6_0.PerformanceDatasetsApi(isilon_sdk.v9_6_0.ApiClient(configuration))
dataset_workload = isilon_sdk.v9_6_0.DatasetWorkloadCreateParams() # DatasetWorkloadCreateParams | 
dataset = 'dataset_example' # str | 
force = true # bool | For use by support only. (optional)
...
# create an instance of the API class
api_instance = isilon_sdk.v9_6_0.PerformanceDatasetsApi(isilon_sdk.v9_6_0.ApiClient(configuration))
dataset_filter = isilon_sdk.v9_6_0.DatasetFilter() # DatasetFilter | 
...
# create an instance of the API class
api_instance = isilon_sdk.v9_6_0.PerformanceDatasetsApi(isilon_sdk.v9_6_0.ApiClient(configuration))
dataset_workload = isilon_sdk.v9_6_0.DatasetWorkload() # DatasetWorkload | 
