...
class ClusterEmailExtended(object):
    ...
    def smtp_auth_username(self, smtp_auth_username):
        ...
        if smtp_auth_username is not None and not re.search(r'^[a-zA-Z0-9!@#%^&(){}~`_ .-]+$', smtp_auth_username):  # noqa: E501
            raise ValueError(r"Invalid value for `smtp_auth_username`, must be a follow pattern or equal to `/^[a-zA-Z0-9!@#%^&(){}~`_ .-]+$/`")  # noqa: E501
