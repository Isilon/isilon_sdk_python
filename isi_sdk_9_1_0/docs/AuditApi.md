...
api_instance = isi_sdk_9_1_0.AuditApi(isi_sdk_9_1_0.ApiClient(configuration))
audit_topic = isi_sdk_9_1_0.AuditTopicCreateParams() # AuditTopicCreateParams | 
...
# create an instance of the API class
api_instance = isi_sdk_9_1_0.AuditApi(isi_sdk_9_1_0.ApiClient(configuration))
audit_settings = isi_sdk_9_1_0.AuditSettingsSettings() # AuditSettingsSettings | 
zone = 'zone_example' # str | Access zone which contains audit settings. (optional)
...
# create an instance of the API class
api_instance = isi_sdk_9_1_0.AuditApi(isi_sdk_9_1_0.ApiClient(configuration))
audit_topic = isi_sdk_9_1_0.AuditTopic() # AuditTopic | 
...
# create an instance of the API class
api_instance = isi_sdk_9_1_0.AuditApi(isi_sdk_9_1_0.ApiClient(configuration))
settings_global = isi_sdk_9_1_0.SettingsGlobalSettings() # SettingsGlobalSettings | 
force = true # bool | Do not ask for confirmation. (optional)
