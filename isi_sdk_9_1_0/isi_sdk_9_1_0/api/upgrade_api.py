...
class UpgradeApi(object):
    ...
    def create_cluster_firmware_upgrade_item_with_http_info(self, cluster_firmware_upgrade_item, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/10/upgrade/cluster/firmware/upgrade', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def create_cluster_patch_patch_with_http_info(self, cluster_patch_patch, **kwargs):  # noqa: E501
        ...
        all_params = ['cluster_patch_patch', 'skip_conflict_check', 'skip_restricted_check', 'skip_dependency_check', 'skip_version_check', 'process_type']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def delete_cluster_patch_patch_with_http_info(self, cluster_patch_patch_id, **kwargs):  # noqa: E501
        ...
        all_params = ['cluster_patch_patch_id', 'skip_conflict_check', 'skip_restricted_check', 'skip_dependency_check', 'skip_version_check', 'process_type']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_cluster_firmware_status_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['refresh', 'devices']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
