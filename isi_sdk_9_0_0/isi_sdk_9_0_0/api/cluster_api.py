...
class ClusterApi(object):
    ...
    def get_cluster_node_with_http_info(self, cluster_node_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/10/cluster/nodes/{ClusterNodeId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_cluster_node(self, cluster_node_id, **kwargs):  # noqa: E501
        """update_cluster_node  # noqa: E501

        Modify one or more node settings.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_cluster_node(cluster_node_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_cluster_node_with_http_info(cluster_node_id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_cluster_node_with_http_info(cluster_node_id, **kwargs)  # noqa: E501
            return data

    def update_cluster_node_with_http_info(self, cluster_node_id, **kwargs):  # noqa: E501
        """update_cluster_node  # noqa: E501

        Modify one or more node settings.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_cluster_node_with_http_info(cluster_node_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/platform/10/cluster/nodes/{ClusterNodeId}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
