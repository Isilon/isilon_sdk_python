...
api_instance = isi_sdk_9_0_0.FileFilterApi(isi_sdk_9_0_0.ApiClient(configuration))
...
# create an instance of the API class
api_instance = isi_sdk_9_0_0.FileFilterApi(isi_sdk_9_0_0.ApiClient(configuration))
file_filter_settings = isi_sdk_9_0_0.FileFilterSettingsExtended() # FileFilterSettingsExtended | 
zone = 'zone_example' # str | Specifies the access zones in which these settings apply. (optional)
