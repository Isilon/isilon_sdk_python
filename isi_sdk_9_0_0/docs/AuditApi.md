...
api_instance = isi_sdk_9_0_0.AuditApi(isi_sdk_9_0_0.ApiClient(configuration))
audit_topic = isi_sdk_9_0_0.AuditTopicCreateParams() # AuditTopicCreateParams | 
...
# create an instance of the API class
api_instance = isi_sdk_9_0_0.AuditApi(isi_sdk_9_0_0.ApiClient(configuration))
audit_settings = isi_sdk_9_0_0.AuditSettingsSettings() # AuditSettingsSettings | 
zone = 'zone_example' # str | Access zone which contains audit settings. (optional)
...
# create an instance of the API class
api_instance = isi_sdk_9_0_0.AuditApi(isi_sdk_9_0_0.ApiClient(configuration))
audit_topic = isi_sdk_9_0_0.AuditTopic() # AuditTopic | 
...
# create an instance of the API class
api_instance = isi_sdk_9_0_0.AuditApi(isi_sdk_9_0_0.ApiClient(configuration))
settings_global = isi_sdk_9_0_0.SettingsGlobalSettings() # SettingsGlobalSettings | 
