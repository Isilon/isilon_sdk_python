...
class DatasetFilterMetricValues(object):
    ...
    def __init__(self, groupname=None, job_type=None, local_address=None, path=None, protocol=None, remote_address=None, share_name=None, system_name=None, username=None, zone_name=None):  # noqa: E501
