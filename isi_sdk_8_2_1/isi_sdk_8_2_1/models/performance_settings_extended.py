...
class PerformanceSettingsExtended(object):
    ...
    def __init__(self, max_filter_count=None, max_stat_size=None, max_top_n_collection_count=None, max_workload_count=None, top_n_collection_count=None):  # noqa: E501
