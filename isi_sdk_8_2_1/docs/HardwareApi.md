...
api_instance = isi_sdk_8_2_1.HardwareApi(isi_sdk_8_2_1.ApiClient(configuration))
hardware_tape_name = isi_sdk_8_2_1.Empty() # Empty | 
...
# create an instance of the API class
api_instance = isi_sdk_8_2_1.HardwareApi(isi_sdk_8_2_1.ApiClient(configuration))
hardware_fcport = isi_sdk_8_2_1.HardwareFcport() # HardwareFcport | 
...
# create an instance of the API class
api_instance = isi_sdk_8_2_1.HardwareApi(isi_sdk_8_2_1.ApiClient(configuration))
hardware_tape_name_params = isi_sdk_8_2_1.HardwareTapeNameParams() # HardwareTapeNameParams | 
