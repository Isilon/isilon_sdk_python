# isi_sdk_8_2_1.SnapshotChangelistsApi

All URIs are relative to *https://YOUR_CLUSTER_HOSTNAME_OR_NODE_IP:8080*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_changelist_entries**](SnapshotChangelistsApi.md#get_changelist_entries) | **GET** /platform/8/snapshot/changelists/{Changelist}/entries | 
[**get_changelist_entry**](SnapshotChangelistsApi.md#get_changelist_entry) | **GET** /platform/8/snapshot/changelists/{Changelist}/entries/{ChangelistEntryId} | 
...
> ChangelistEntriesExtended get_changelist_entries(changelist, limit=limit, resume=resume)
...
api_instance = isi_sdk_8_2_1.SnapshotChangelistsApi(isi_sdk_8_2_1.ApiClient(configuration))
changelist = 'changelist_example' # str | 
limit = 56 # int | Return no more than this many results at once (see resume). (optional)
resume = 'resume_example' # str | Continue returning results from previous call using this token (token should come from the previous call, resume cannot be used with other options). (optional)

try:
    api_response = api_instance.get_changelist_entries(changelist, limit=limit, resume=resume)
    pprint(api_response)
