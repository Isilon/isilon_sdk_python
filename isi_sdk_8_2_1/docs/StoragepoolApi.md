...
api_instance = isi_sdk_8_2_1.StoragepoolApi(isi_sdk_8_2_1.ApiClient(configuration))
compatibilities_class_active_item = isi_sdk_8_2_1.CompatibilitiesClassActiveItem() # CompatibilitiesClassActiveItem | 
...
# create an instance of the API class
api_instance = isi_sdk_8_2_1.StoragepoolApi(isi_sdk_8_2_1.ApiClient(configuration))
compatibilities_ssd_active_item = isi_sdk_8_2_1.CompatibilitiesSsdActiveItem() # CompatibilitiesSsdActiveItem | 
assess = true # bool | Do not perform action, only test that it is possible. (optional)
...
# create an instance of the API class
api_instance = isi_sdk_8_2_1.StoragepoolApi(isi_sdk_8_2_1.ApiClient(configuration))
storagepool_nodepool = isi_sdk_8_2_1.StoragepoolNodepoolCreateParams() # StoragepoolNodepoolCreateParams | 
...
# create an instance of the API class
api_instance = isi_sdk_8_2_1.StoragepoolApi(isi_sdk_8_2_1.ApiClient(configuration))
storagepool_tier = isi_sdk_8_2_1.StoragepoolTierCreateParams() # StoragepoolTierCreateParams | 
...
# create an instance of the API class
api_instance = isi_sdk_8_2_1.StoragepoolApi(isi_sdk_8_2_1.ApiClient(configuration))
compatibilities_ssd_active_id_params = isi_sdk_8_2_1.CompatibilitiesSsdActiveIdParams() # CompatibilitiesSsdActiveIdParams | 
...
# create an instance of the API class
api_instance = isi_sdk_8_2_1.StoragepoolApi(isi_sdk_8_2_1.ApiClient(configuration))
storagepool_nodepool = isi_sdk_8_2_1.StoragepoolNodepool() # StoragepoolNodepool | 
...
# create an instance of the API class
api_instance = isi_sdk_8_2_1.StoragepoolApi(isi_sdk_8_2_1.ApiClient(configuration))
storagepool_settings = isi_sdk_8_2_1.StoragepoolSettingsExtended() # StoragepoolSettingsExtended | 
...
# create an instance of the API class
api_instance = isi_sdk_8_2_1.StoragepoolApi(isi_sdk_8_2_1.ApiClient(configuration))
storagepool_tier = isi_sdk_8_2_1.StoragepoolTier() # StoragepoolTier | 
