...
api_instance = isi_sdk_8_2_2.FilepoolApi(isi_sdk_8_2_2.ApiClient(configuration))
filepool_policy = isi_sdk_8_2_2.FilepoolPolicyCreateParams() # FilepoolPolicyCreateParams | 
...
# create an instance of the API class
api_instance = isi_sdk_8_2_2.FilepoolApi(isi_sdk_8_2_2.ApiClient(configuration))
filepool_default_policy = isi_sdk_8_2_2.FilepoolDefaultPolicyExtended() # FilepoolDefaultPolicyExtended | 
...
# create an instance of the API class
api_instance = isi_sdk_8_2_2.FilepoolApi(isi_sdk_8_2_2.ApiClient(configuration))
filepool_policy = isi_sdk_8_2_2.FilepoolPolicy() # FilepoolPolicy | 
