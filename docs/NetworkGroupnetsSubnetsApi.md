# isi_sdk_8_1_1.NetworkGroupnetsSubnetsApi
...
api_instance = isi_sdk_8_1_1.NetworkGroupnetsSubnetsApi(isi_sdk_8_1_1.ApiClient(configuration))
pools_pool_rebalance_ip = isi_sdk_8_1_1.Empty() # Empty | 
...
# create an instance of the API class
api_instance = isi_sdk_8_1_1.NetworkGroupnetsSubnetsApi(isi_sdk_8_1_1.ApiClient(configuration))
pools_pool_rule = isi_sdk_8_1_1.PoolsPoolRuleCreateParams() # PoolsPoolRuleCreateParams | 
groupnet = 'groupnet_example' # str | 
subnet = 'subnet_example' # str | 
pool = 'pool_example' # str | 
...
# create an instance of the API class
api_instance = isi_sdk_8_1_1.NetworkGroupnetsSubnetsApi(isi_sdk_8_1_1.ApiClient(configuration))
pools_pool_sc_resume_node = isi_sdk_8_1_1.PoolsPoolScResumeNode() # PoolsPoolScResumeNode | 
groupnet = 'groupnet_example' # str | 
subnet = 'subnet_example' # str | 
pool = 'pool_example' # str | 
...
# create an instance of the API class
api_instance = isi_sdk_8_1_1.NetworkGroupnetsSubnetsApi(isi_sdk_8_1_1.ApiClient(configuration))
pools_pool_sc_suspend_node = isi_sdk_8_1_1.PoolsPoolScResumeNode() # PoolsPoolScResumeNode | 
groupnet = 'groupnet_example' # str | 
subnet = 'subnet_example' # str | 
pool = 'pool_example' # str | 
...
# create an instance of the API class
api_instance = isi_sdk_8_1_1.NetworkGroupnetsSubnetsApi(isi_sdk_8_1_1.ApiClient(configuration))
pools_pool_rule = isi_sdk_8_1_1.PoolsPoolRule() # PoolsPoolRule | 
