# isi_sdk_8_2_2.SnapshotSnapshotsApi
...
api_instance = isi_sdk_8_2_2.SnapshotSnapshotsApi(isi_sdk_8_2_2.ApiClient(configuration))
snapshot_lock = isi_sdk_8_2_2.SnapshotLockCreateParams() # SnapshotLockCreateParams | 
sid = 'sid_example' # str | 
...
# create an instance of the API class
api_instance = isi_sdk_8_2_2.SnapshotSnapshotsApi(isi_sdk_8_2_2.ApiClient(configuration))
snapshot_lock = isi_sdk_8_2_2.SnapshotLock() # SnapshotLock | 
