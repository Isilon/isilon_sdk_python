# isi_sdk_8_1_0.ProtocolsHdfsApi
...
api_instance = isi_sdk_8_1_0.ProtocolsHdfsApi(isi_sdk_8_1_0.ApiClient(configuration))
proxyusers_name_member = isi_sdk_8_1_0.AuthAccessAccessItemFileGroup() # AuthAccessAccessItemFileGroup | 
...
# create an instance of the API class
api_instance = isi_sdk_8_1_0.ProtocolsHdfsApi(isi_sdk_8_1_0.ApiClient(configuration))
proxyusers_name_member = isi_sdk_8_1_0.Empty() # Empty | 
