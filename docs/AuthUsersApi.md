...
api_instance = isi_sdk_8_1_1.AuthUsersApi(isi_sdk_8_1_1.ApiClient(configuration))
user_member_of_item = isi_sdk_8_1_1.AuthAccessAccessItemFileGroup() # AuthAccessAccessItemFileGroup | 
...
# create an instance of the API class
api_instance = isi_sdk_8_1_1.AuthUsersApi(isi_sdk_8_1_1.ApiClient(configuration))
user_change_password = isi_sdk_8_1_1.UserChangePassword() # UserChangePassword | 
user = 'user_example' # str | 
