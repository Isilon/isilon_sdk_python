...
**paths** | **list[str]** | The paths under /ifs that are exported. | [optional] 
...
**conflicting_paths** | **list[str]** | Paths that conflict with another export. | [optional] 
**id** | **int** | Unique ID for the export. | [optional] 
**unresolved_clients** | **list[str]** | Clients that cannot be resolved. | [optional] 
