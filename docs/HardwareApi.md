...
api_instance = isi_sdk_8_2_2.HardwareApi(isi_sdk_8_2_2.ApiClient(configuration))
hardware_tape_name = isi_sdk_8_2_2.Empty() # Empty | 
...
# create an instance of the API class
api_instance = isi_sdk_8_2_2.HardwareApi(isi_sdk_8_2_2.ApiClient(configuration))
hardware_fcport = isi_sdk_8_2_2.HardwareFcport() # HardwareFcport | 
...
# create an instance of the API class
api_instance = isi_sdk_8_2_2.HardwareApi(isi_sdk_8_2_2.ApiClient(configuration))
hardware_tape_name_params = isi_sdk_8_2_2.HardwareTapeNameParams() # HardwareTapeNameParams | 
