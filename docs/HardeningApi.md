...
api_instance = isi_sdk_8_1_0.HardeningApi(isi_sdk_8_1_0.ApiClient(configuration))
hardening_apply_item = isi_sdk_8_1_0.HardeningApplyItem() # HardeningApplyItem | 
...
# create an instance of the API class
api_instance = isi_sdk_8_1_0.HardeningApi(isi_sdk_8_1_0.ApiClient(configuration))
hardening_resolve_item = isi_sdk_8_1_0.HardeningResolveItem() # HardeningResolveItem | 
...
# create an instance of the API class
api_instance = isi_sdk_8_1_0.HardeningApi(isi_sdk_8_1_0.ApiClient(configuration))
hardening_revert_item = isi_sdk_8_1_0.Empty() # Empty | 
