...
api_instance = isi_sdk_8_2_2.HardeningApi(isi_sdk_8_2_2.ApiClient(configuration))
hardening_apply_item = isi_sdk_8_2_2.HardeningApplyItem() # HardeningApplyItem | 
...
# create an instance of the API class
api_instance = isi_sdk_8_2_2.HardeningApi(isi_sdk_8_2_2.ApiClient(configuration))
hardening_resolve_item = isi_sdk_8_2_2.HardeningResolveItem() # HardeningResolveItem | 
...
# create an instance of the API class
api_instance = isi_sdk_8_2_2.HardeningApi(isi_sdk_8_2_2.ApiClient(configuration))
hardening_revert_item = isi_sdk_8_2_2.Empty() # Empty | 
