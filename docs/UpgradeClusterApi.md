# isi_sdk_8_0_1.UpgradeClusterApi
...
api_instance = isi_sdk_8_0_1.UpgradeClusterApi(isi_sdk_8_0_1.ApiClient(configuration))
nodes_node_patch_sync_item = isi_sdk_8_0_1.Empty() # Empty | 
lnn = 56 # int | 
