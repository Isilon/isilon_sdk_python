# isi_sdk_8_2_2.UpgradeClusterApi
...
api_instance = isi_sdk_8_2_2.UpgradeClusterApi(isi_sdk_8_2_2.ApiClient(configuration))
nodes_node_patch_sync_item = isi_sdk_8_2_2.Empty() # Empty | 
lnn = 56 # int | 
