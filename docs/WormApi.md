...
api_instance = isi_sdk_8_0_1.WormApi(isi_sdk_8_0_1.ApiClient(configuration))
worm_domain = isi_sdk_8_0_1.WormDomainCreateParams() # WormDomainCreateParams | 
...
# create an instance of the API class
api_instance = isi_sdk_8_0_1.WormApi(isi_sdk_8_0_1.ApiClient(configuration))
worm_domain = isi_sdk_8_0_1.WormDomain() # WormDomain | 
...
# create an instance of the API class
api_instance = isi_sdk_8_0_1.WormApi(isi_sdk_8_0_1.ApiClient(configuration))
worm_settings = isi_sdk_8_0_1.WormSettingsExtended() # WormSettingsExtended | 
