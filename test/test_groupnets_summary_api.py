...
from isi_sdk_8_2_2.api.groupnets_summary_api import GroupnetsSummaryApi  # noqa: E501
...
class TestGroupnetsSummaryApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = isi_sdk_8_2_2.api.groupnets_summary_api.GroupnetsSummaryApi()  # noqa: E501
