...
from swagger_client.apis.network_groupnets_subnets_api import NetworkGroupnetsSubnetsApi
...
class TestNetworkGroupnetsSubnetsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = swagger_client.apis.network_groupnets_subnets_api.NetworkGroupnetsSubnetsApi()
