...
from isi_sdk_8_2_2.models.result_directories_total_usage import ResultDirectoriesTotalUsage  # noqa: E501
...
class TestResultDirectoriesTotalUsage(unittest.TestCase):
    ...
    def testResultDirectoriesTotalUsage(self):
        ...
        # model = isi_sdk_8_2_2.models.result_directories_total_usage.ResultDirectoriesTotalUsage()  # noqa: E501
        pass
